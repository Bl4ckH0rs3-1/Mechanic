...
L["HELP_INSPECT_PICK_BODY"] = "Click the Pick button to enter pick mode. Hover over any frame in the game UI and click to select it for inspection. Press ESC to cancel."
L["HELP_INSPECT_PATH_HEADING"] = "Path Input"
L["HELP_INSPECT_PATH_BODY"] = "Type a frame path (e.g., PlayerFrame.healthBar) or global table name directly. Press Enter to inspect."
L["HELP_INSPECT_WATCH_HEADING"] = "Watch List (+ Watch)"
L["HELP_INSPECT_WATCH_BODY"] = "Pin the current frame to the Watch List for live value monitoring. Watched frames update automatically and persist across tab switches."
L["HELP_INSPECT_CHAT_HEADING"] = "Chat Integration"
L["HELP_INSPECT_CHAT_BODY"] = "Use /mech inspect <path> to inspect from chat. Useful for bug reports: share the exact path with other developers."
L["HELP_INSPECT_TREE_HEADING"] = "Tree Navigation"
L["HELP_INSPECT_TREE_BODY"] = "The left panel shows frame hierarchy. Click nodes to navigate ancestors (parents) and children. Disabled for plain tables."
L["HELP_INSPECT_PROPERTIES_HEADING"] = "Live Properties"
L["HELP_INSPECT_PROPERTIES_BODY"] = "The Properties panel allows real-time editing of frame attributes. Changes are applied instantly. Use the Export button to generate Lua code for your changes."
L["HELP_INSPECT_EXPORT_HEADING"] = "Export"
L["HELP_INSPECT_EXPORT_BODY"] = "Copy all frame properties to clipboard for bug reports or AI agent context. Includes optional environment header."

-- Help: Console Tab
L["HELP_CONSOLE_TITLE"] = "Console Tab"
L["HELP_CONSOLE_FILTER_HEADING"] = "Filtering"
L["HELP_CONSOLE_FILTER_BODY"] = "Select an addon in the left nav to filter logs by source. Use the search box for text matching across message, source, and category."
L["HELP_CONSOLE_DEDUP_HEADING"] = "Dedup Modes"
L["HELP_CONSOLE_DEDUP_BODY"] = "Dedup All removes duplicate messages entirely. Dedup Adjacent collapses repeated consecutive messages with a count (x5)."
L["HELP_CONSOLE_PAUSE_HEADING"] = "Pause/Resume"
L["HELP_CONSOLE_PAUSE_BODY"] = "Pause stops capturing new log entries, letting you review the current output without scroll. Resume to continue logging."
L["HELP_CONSOLE_EXPORT_HEADING"] = "Export"
L["HELP_CONSOLE_EXPORT_BODY"] = "Copy filtered logs to clipboard. Optional environment header provides context for bug reports."

-- Help: Errors Tab
L["HELP_ERRORS_TITLE"] = "Errors Tab"
L["HELP_ERRORS_SESSION_HEADING"] = "Session Filter"
L["HELP_ERRORS_SESSION_BODY"] = "View errors from the current session, previous session, or all sessions combined. Useful for tracking down issues that occurred before a reload."
L["HELP_ERRORS_NAV_HEADING"] = "Error Navigation"
L["HELP_ERRORS_NAV_BODY"] = "Use the < > buttons to step through errors. Click an error in the list to view its full stack trace and local variables."
L["HELP_ERRORS_CONSOLE_HEADING"] = "To Console"
L["HELP_ERRORS_CONSOLE_BODY"] = "Send the selected error to the Console tab. This provides context by showing the error alongside other log messages."
L["HELP_ERRORS_BUGGRABBER_HEADING"] = "BugGrabber Dependency"
L["HELP_ERRORS_BUGGRABBER_BODY"] = "This module requires !BugGrabber to capture Lua errors. Download it from CurseForge if not installed."

-- Help: Tests Tab
L["HELP_TESTS_TITLE"] = "Tests Tab"
L["HELP_TESTS_TREE_HEADING"] = "Test Tree"
L["HELP_TESTS_TREE_BODY"] = "Browse tests organized by addon and category. Click a test to view its details, status, and any captured log output."
L["HELP_TESTS_RUN_HEADING"] = "Run Selected"
L["HELP_TESTS_RUN_BODY"] = "Execute the currently selected test and display the result. View pass/fail status, duration, and any error messages."
L["HELP_TESTS_AUTO_HEADING"] = "Run All Auto"
L["HELP_TESTS_AUTO_BODY"] = "Run all tests marked with autoRun = true. These are typically fast, non-destructive validation tests."
L["HELP_TESTS_RESULTS_HEADING"] = "Results"
L["HELP_TESTS_RESULTS_BODY"] = "Green = passed, Red = failed, Gray = pending/not run. Failed tests show error messages and captured log context."

-- Help: Performance Tab
L["HELP_PERF_TITLE"] = "Performance Tab"
L["HELP_PERF_CPU_HEADING"] = "CPU Profiling"
L["HELP_PERF_CPU_BODY"] = "Toggle CPU profiling to track per-addon CPU usage in ms/s. Requires a UI reload to enable/disable. Shows percentage of total frame time."
L["HELP_PERF_REFRESH_HEADING"] = "Auto-Refresh"
L["HELP_PERF_REFRESH_BODY"] = "Continuously updates metrics every few seconds. Disable for snapshot analysis or when you want stable numbers."
L["HELP_PERF_SUBMETRICS_HEADING"] = "Sub-Metrics"
L["HELP_PERF_SUBMETRICS_BODY"] = "Click an addon in the list to see its registered sub-metrics breakdown (if available). Addons can register custom metrics via MechanicLib."
L["HELP_PERF_RESET_HEADING"] = "Reset Stats"
L["HELP_PERF_RESET_BODY"] = "Clear accumulated performance data for a fresh measurement starting point. Useful after major events or loading screens."

-- Help: Tools Tab
L["HELP_TOOLS_TITLE"] = "Tools Tab"
L["HELP_TOOLS_ADDON_HEADING"] = "Addon Tools"
L["HELP_TOOLS_ADDON_BODY"] = "Select an addon in the left nav to access its registered diagnostic panels. Addons register tools via MechanicLib:Register()."
L["HELP_TOOLS_HEALTH_HEADING"] = "Health Log"
L["HELP_TOOLS_HEALTH_BODY"] = "View !Mechanic's internal error and lifecycle log. Persists across reloads for post-mortem debugging."
L["HELP_TOOLS_RESET_HEADING"] = "Reset UI"
L["HELP_TOOLS_RESET_BODY"] = "Restore the main Mechanic window to its default size and position. Useful if the window gets stuck off-screen."

-- Help: API Tab
L["HELP_API_TITLE"] = "API Tab"
L["HELP_API_BROWSER_HEADING"] = "API Browser"
L["HELP_API_BROWSER_BODY"] = "Browse categorized WoW APIs with documentation. Search by name, filter by category, and see Midnight 12.0 readiness status."
L["HELP_API_RUN_HEADING"] = "Run"
L["HELP_API_RUN_BODY"] = "Execute the selected API with default parameters to test availability. Shows return values or error messages."
L["HELP_API_CATEGORY_HEADING"] = "Run Category"
L["HELP_API_CATEGORY_BODY"] = "Batch test all APIs in the selected category. Quickly identify which APIs are available, protected, or missing."
L["HELP_API_MIDNIGHT_HEADING"] = "Midnight Impact"
L["HELP_API_MIDNIGHT_BODY"] = "Shows if an API is unchanged, conditionally affected, protected, or missing in Midnight 12.0. Green = safe, Yellow = conditional, Red = breaking."