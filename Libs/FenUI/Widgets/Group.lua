...
function GroupMixin:LayoutCells()
    ...
    local totalSize = isVertical 
        and (self:GetHeight() - (p.top + p.bottom + m.top + m.bottom))
...
function GroupBuilder:name(name) self._config.name = name; return self end
function GroupBuilder:size(w, h) self._config.width = w; self._config.height = h; return self end
function GroupBuilder:width(w) self._config.width = w; return self end
function GroupBuilder:height(h) self._config.height = h; return self end
function GroupBuilder:minWidth(w) self._config.minWidth = w; return self end
function GroupBuilder:maxWidth(w) self._config.maxWidth = w; return self end
function GroupBuilder:minHeight(h) self._config.minHeight = h; return self end
function GroupBuilder:maxHeight(h) self._config.maxHeight = h; return self end
function GroupBuilder:aspectRatio(r, b) self._config.aspectRatio = r; self._config.aspectBase = b or "width"; return self end
function GroupBuilder:padding(p) self._config.padding = p; return self end
function GroupBuilder:paddingTop(p) self._config.paddingTop = p; return self end
function GroupBuilder:paddingBottom(p) self._config.paddingBottom = p; return self end
function GroupBuilder:paddingLeft(p) self._config.paddingLeft = p; return self end
function GroupBuilder:paddingRight(p) self._config.paddingRight = p; return self end
function GroupBuilder:rows(r) self._config.rows = r; return self end
function GroupBuilder:cols(c) self._config.cols = c; return self end
function GroupBuilder:gap(g) self._config.gap = g; return self end
