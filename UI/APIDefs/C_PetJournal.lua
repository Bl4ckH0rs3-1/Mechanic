...
APIDefs["C_PetJournal.GetPetLoadOutInfo"] = {
    ...
    params = { { name = "slot", type = "luaIndex", default = nil , examples = { { value = 1, label = "Leatrix_Plus" }, { value = 2, label = "Leatrix_Plus" }, { value = 3, label = "Leatrix_Plus" } } } },
...
APIDefs["C_PetJournal.SetSearchFilter"] = {
    ...
    params = { { name = "filterText", type = "cstring", default = nil , examples = { { value = "self", label = "AllTheThings" }, { value = "self", label = "AllTheThings" }, { value = "self", label = "AllTheThings" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
