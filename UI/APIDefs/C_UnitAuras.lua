...
APIDefs["C_UnitAuras.AddPrivateAuraAppliedSound"] = {
    ...
    params = { { name = "sound", type = "UnitPrivateAuraAppliedSoundInfo", default = nil , examples = { { value = "{ 					spellID = opt[i]", label = "BigWigs_Core" }, { value = "{ 				spellID = auraspellId", label = "DBM-Core" } } } },
...
APIDefs["C_UnitAuras.AuraIsBigDefensive"] = {
    ...
    params = { { name = "spellID", type = "number", default = nil , examples = { { value = "unit", label = "DandersFrames" }, { value = "unit", label = "DandersFrames" } } } },
...
APIDefs["C_UnitAuras.DoesAuraHaveExpirationTime"] = {
    ...
    params = { { name = "auraInstanceUnit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "DandersFrames" } } }, { name = "auraInstanceID", type = "number", default = nil } },
...
APIDefs["C_UnitAuras.GetAuraApplicationDisplayCount"] = {
    ...
    params = { { name = "auraInstanceUnit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "DandersFrames" } } }, { name = "auraInstanceID", type = "number", default = nil }, { name = "minDisplayCount", type = "number", default = 2 }, { name = "maxDisplayCount", type = "number", default = nil } },
...
APIDefs["C_UnitAuras.GetAuraDataByAuraInstanceID"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" }, { value = "unitId", label = "Details" }, { value = "player", label = "Details" } } }, { name = "auraInstanceID", type = "number", default = nil } },
...
APIDefs["C_UnitAuras.GetAuraDataByIndex"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "DandersFrames" }, { value = "player", label = "DandersFrames" }, { value = "unit", label = "DandersFrames" } } }, { name = "index", type = "luaIndex", default = nil }, { name = "filter", type = "AuraFilters", default = nil } },
    returns = { { name = "aura", type = "AuraData", canBeSecret = false } },
    midnightImpact = "CONDITIONAL",
    midnightNote = "Secret behavior: SecretWhenAuraDataRestricted, SecretArguments=AllowedWhenTainted",
}
...
APIDefs["C_UnitAuras.GetAuraDataBySlot"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "Plater" } } }, { name = "slot", type = "number", default = nil } },
    returns = { { name = "aura", type = "AuraData", canBeSecret = false } },
    midnightImpact = "CONDITIONAL",
    midnightNote = "Secret behavior: SecretWhenAuraDataRestricted, SecretArguments=AllowedWhenTainted",
}
...
APIDefs["C_UnitAuras.GetAuraDataBySpellName"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "DandersFrames" }, { value = "uId", label = "DBM-Core" }, { value = "uId", label = "DBM-Core" } } }, { name = "spellName", type = "cstring", default = nil }, { name = "filter", type = "AuraFilters", default = nil } },
    returns = { { name = "aura", type = "AuraData", canBeSecret = false } },
    midnightImpact = "CONDITIONAL",
    midnightNote = "Secret behavior: SecretWhenAuraDataRestricted, SecretArguments=AllowedWhenTainted",
}
...
APIDefs["C_UnitAuras.GetAuraDispelTypeColor"] = {
    ...
    params = { { name = "auraInstanceUnit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "DandersFrames" }, { value = "unit", label = "DandersFrames" }, { value = "unit", label = "DandersFrames" } } }, { name = "auraInstanceID", type = "number", default = nil }, { name = "curve", type = "LuaColorCurveObject", default = nil } },
...
APIDefs["C_UnitAuras.GetAuraDurationRemaining"] = {
    ...
    params = { { name = "auraInstanceUnit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "ActionHud" } } }, { name = "auraInstanceID", type = "number", default = nil } },
...
APIDefs["C_UnitAuras.GetAuraSlots"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "Plater" }, { value = "unitId", label = "Plater" }, { value = "unitId", label = "Plater" } } }, { name = "filter", type = "AuraFilters", default = nil }, { name = "maxSlots", type = "number", default = nil }, { name = "continuationToken", type = "number", default = nil } },
...
APIDefs["C_UnitAuras.GetBuffDataByIndex"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "player", label = "Leatrix_Plus" }, { value = "target", label = "Plumber" }, { value = "player", label = "Simulationcraft" } } }, { name = "index", type = "luaIndex", default = nil }, { name = "filter", type = "AuraFilters", default = nil } },
    returns = { { name = "aura", type = "AuraData", canBeSecret = false } },
    midnightImpact = "CONDITIONAL",
    midnightNote = "Secret behavior: SecretWhenAuraDataRestricted, SecretArguments=AllowedWhenTainted",
}
...
APIDefs["C_UnitAuras.GetDebuffDataByIndex"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "player", label = "Leatrix_Plus" }, { value = "unit", label = "RaidAchievement" }, { value = "unit", label = "RaidAchievement" } } }, { name = "index", type = "luaIndex", default = nil }, { name = "filter", type = "AuraFilters", default = nil } },
    returns = { { name = "aura", type = "AuraData", canBeSecret = false } },
    midnightImpact = "CONDITIONAL",
    midnightNote = "Secret behavior: SecretWhenAuraDataRestricted, SecretArguments=AllowedWhenTainted",
}
...
APIDefs["C_UnitAuras.GetPlayerAuraBySpellID"] = {
    ...
    params = { { name = "spellID", type = "number", default = nil , examples = { { value = 11327, label = "Details" }, { value = 355752, label = "Narcissus" } } } },
    returns = { { name = "aura", type = "AuraData", canBeSecret = false } },
    midnightImpact = "CONDITIONAL",
    midnightNote = "Secret behavior: SecretWhenAuraDataRestricted, SecretArguments=AllowedWhenTainted",
}
...
APIDefs["C_UnitAuras.GetUnitAuraBySpellID"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "BigWigs_Core" }, { value = "player", label = "Plumber" } } }, { name = "spellID", type = "number", default = nil } },
    returns = { { name = "aura", type = "AuraData", canBeSecret = false } },
    midnightImpact = "CONDITIONAL",
    midnightNote = "Secret behavior: SecretWhenAuraDataRestricted, SecretArguments=AllowedWhenTainted",
}
...
APIDefs["C_UnitAuras.GetUnitAuras"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "DandersFrames" }, { value = "unit", label = "DandersFrames" }, { value = "unit", label = "DandersFrames" } } }, { name = "filter", type = "AuraFilters", default = nil }, { name = "maxCount", type = "number", default = nil }, { name = "sortRule", type = "UnitAuraSortRule", default = "Unsorted" }, { name = "sortDirection", type = "UnitAuraSortDirection", default = "Normal" } },
...
APIDefs["C_UnitAuras.IsAuraFilteredOutByInstanceID"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "DandersFrames" }, { value = "unit", label = "DandersFrames" }, { value = "unit", label = "DandersFrames" } } }, { name = "auraInstanceID", type = "number", default = nil }, { name = "filter", type = "AuraFilters", default = nil } },
...
APIDefs["C_UnitAuras.RemovePrivateAuraAppliedSound"] = {
    ...
    params = { { name = "privateAuraSoundID", type = "number", default = nil , examples = { { value = "id", label = "DBM-Core" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_UnitAuras.WantsAlteredForm"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "Narcissus" }, { value = "player", label = "Narcissus" } } } },
