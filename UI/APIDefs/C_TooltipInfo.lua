...
APIDefs["C_TooltipInfo.GetAction"] = {
    ...
    params = { { name = "actionID", type = "luaIndex", default = nil , examples = { { value = "target", label = "WeakAurasOptions" }, { value = "target", label = "WeakAurasOptions" } } } },
    returns = { { name = "data", type = "TooltipData", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_TooltipInfo.GetHyperlink"] = {
    ...
    params = { { name = "hyperlink", type = "cstring", default = nil , examples = { { value = [=["unit:" .. petGUID]=], label = "Details" }, { value = "'unit:'.. petGUID", label = "Details" }, { value = [=["unit:" .. actorObject.serial]=], label = "Details" } } }, { name = "optionalArg1", type = "number", default = nil }, { name = "optionalArg2", type = "number", default = nil }, { name = "hideVendorPrice", type = "bool", default = nil } },
    returns = { { name = "data", type = "TooltipData", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_TooltipInfo.GetInventoryItem"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "player", label = "WeakAuras" }, { value = "player", label = "DejaCharacterStats" }, { value = "unit", label = "DejaCharacterStats" } } }, { name = "slot", type = "luaIndex", default = nil }, { name = "hideUselessStats", type = "bool", default = nil } },
    returns = { { name = "data", type = "TooltipData", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_TooltipInfo.GetItemByID"] = {
    ...
    params = { { name = "itemID", type = "number", default = nil , examples = { { value = "id", label = "BagBrother" } } }, { name = "quality", type = "number", default = nil } },
    returns = { { name = "data", type = "TooltipData", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_TooltipInfo.GetItemKey"] = {
    ...
    params = { { name = "itemID", type = "number", default = nil , examples = { { value = "item.itemLink", label = "Syndicator" } } }, { name = "itemLevel", type = "number", default = nil }, { name = "itemSuffix", type = "number", default = nil }, { name = "requiredLevel", type = "number", default = nil } },
    returns = { { name = "data", type = "TooltipData", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_TooltipInfo.GetSendMailItem"] = {
    ...
    params = { { name = "attachmentIndex", type = "luaIndex", default = nil , examples = { { value = "id", label = "Auctionator" } } } },
    returns = { { name = "data", type = "TooltipData", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_TooltipInfo.GetTraitEntry"] = {
    ...
    params = { { name = "entryID", type = "number", default = nil , examples = { { value = "entryID", label = "Plumber" } } }, { name = "rank", type = "number", default = nil } },
    returns = { { name = "data", type = "TooltipData", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_TooltipInfo.GetUnit"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "guid", label = "WeakAuras" } } }, { name = "hideStatus", type = "bool", default = nil } },
    returns = { { name = "data", type = "TooltipData", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_TooltipInfo.GetUnitAura"] = {
    ...
    params = { { name = "unitToken", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" } } }, { name = "index", type = "luaIndex", default = nil }, { name = "filter", type = "AuraFilters", default = nil } },
    returns = { { name = "data", type = "TooltipData", canBeSecret = false } },
...
APIDefs["C_TooltipInfo.GetUnitBuffByAuraInstanceID"] = {
    ...
    params = { { name = "unitToken", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" }, { value = "player", label = "Narcissus" }, { value = "player", label = "Narcissus" } } }, { name = "auraInstanceID", type = "number", default = nil }, { name = "filter", type = "AuraFilters", default = nil } },
    returns = { { name = "data", type = "TooltipData", canBeSecret = false } },
    midnightImpact = "CONDITIONAL",
...
APIDefs["C_TooltipInfo.GetUnitDebuffByAuraInstanceID"] = {
    ...
    params = { { name = "unitToken", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" } } }, { name = "auraInstanceID", type = "number", default = nil }, { name = "filter", type = "AuraFilters", default = nil } },
    returns = { { name = "data", type = "TooltipData", canBeSecret = false } },
    midnightImpact = "CONDITIONAL",
    midnightNote = "Secret behavior: SecretWhenUnpackedUnitAuraInstanceRestricted, SecretArguments=AllowedWhenTainted",
}
