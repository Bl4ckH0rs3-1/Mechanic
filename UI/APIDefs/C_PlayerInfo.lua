...
APIDefs["C_PlayerInfo.GetClass"] = {
    ...
    params = { { name = "playerLocation", type = "PlayerLocation", default = nil , examples = { { value = "target [1]", label = "Details" }, { value = "t [1]", label = "Details" }, { value = "t[1]", label = "Details" } } } },
...
APIDefs["C_PlayerInfo.GetContentDifficultyCreatureForPlayer"] = {
    ...
    params = { { name = "unitToken", type = "UnitToken", default = "player" , examples = { { value = [=[LT["Unit"]]=], label = "Leatrix_Plus" } } } },
...
APIDefs["C_PlayerInfo.GetName"] = {
    ...
    params = { { name = "playerLocation", type = "PlayerLocation", default = nil , examples = { { value = "id", label = "Narcissus" } } } },
...
APIDefs["C_PlayerInfo.GetPlayerMythicPlusRatingSummary"] = {
    ...
    params = { { name = "playerToken", type = "UnitToken", default = "player" , examples = { { value = 'player', label = "AstralKeys" }, { value = "unit", label = "Narcissus" }, { value = [=[LT["Unit"]]=], label = "!Mechanic" } } } },
...
APIDefs["C_PlayerInfo.UnitIsSameServer"] = {
    ...
    params = { { name = "playerLocation", type = "PlayerLocation", default = nil , examples = { { value = "unit", label = "Details" } } } },
