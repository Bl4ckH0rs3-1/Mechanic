...
APIDefs["C_Bank.CanUseBank"] = {
    ...
    params = { { name = "bankType", type = "BankType", default = nil , examples = { { value = 2, label = "BagBrother" }, { value = 0, label = "BagBrother" } } } },
...
APIDefs["C_Bank.CanViewBank"] = {
    ...
    params = { { name = "bankType", type = "BankType", default = nil , examples = { { value = 0, label = "AllTheThings" }, { value = 2, label = "AllTheThings" } } } },
...
APIDefs["C_Bank.DepositMoney"] = {
    ...
    params = { { name = "bankType", type = "BankType", default = nil , examples = { { value = 2, label = "BagBrother" } } }, { name = "amount", type = "WOWMONEY", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Bank.FetchDepositedMoney"] = {
    ...
    params = { { name = "bankType", type = "BankType", default = nil , examples = { { value = 2, label = "BagBrother" } } } },
