...
APIDefs["C_PetBattles.GetIcon"] = {
    ...
    params = { { name = "petOwner", type = "BattlePetOwner", default = nil , examples = { { value = "unit", label = "BigWigs_NerubarPalace" } } }, { name = "slot", type = "number", default = nil } },
...
APIDefs["C_PetBattles.GetName"] = {
    ...
    params = { { name = "petOwner", type = "BattlePetOwner", default = nil , examples = { { value = "id", label = "Narcissus" } } }, { name = "slot", type = "number", default = nil } },
