...
APIDefs["C_TransmogCollection.GetAppearanceSources"] = {
    ...
    params = { { name = "appearanceID", type = "number", default = nil , examples = { { value = "GetMouseFoci()[1].visualInfo.visualID", label = "Narcissus" } } }, { name = "categoryType", type = "TransmogCollectionType", default = nil }, { name = "transmogLocation", type = "TransmogLocation", default = nil } },
...
APIDefs["C_TransmogCollection.GetCategoryInfo"] = {
    ...
    params = { { name = "category", type = "TransmogCollectionType", default = nil , examples = { { value = 15301, label = "AllTheThings" }, { value = 14941, label = "AllTheThings" }, { value = 15304, label = "AllTheThings" } } } },
...
APIDefs["C_TransmogCollection.GetSourceInfo"] = {
    ...
    params = { { name = "sourceID", type = "number", default = nil , examples = { { value = "item", label = "Narcissus" } } } },
...
APIDefs["C_TransmogCollection.PlayerHasTransmog"] = {
    ...
    params = { { name = "itemID", type = "number", default = nil , examples = { { value = "id", label = "BagBrother" } } }, { name = "itemAppearanceModID", type = "number", default = 0 } },
...
APIDefs["C_TransmogCollection.PlayerKnowsSource"] = {
    ...
    params = { { name = "sourceID", type = "number", default = nil , examples = { { value = "sourceIDs[1]", label = "Narcissus" } } } },
