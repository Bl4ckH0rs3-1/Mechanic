...
APIDefs["C_Container.ContainerIDToInventoryID"] = {
    ...
    params = { { name = "containerID", type = "BagIndex", default = nil , examples = { { value = 1, label = "Syndicator" }, { value = "id", label = "BagBrother" } } } },
...
APIDefs["C_Container.GetBagSlotFlag"] = {
    ...
    params = { { name = "bagIndex", type = "BagIndex", default = nil , examples = { { value = "id", label = "BagBrother" }, { value = "id", label = "BagBrother" } } }, { name = "flag", type = "BagSlotFlags", default = nil } },
...
APIDefs["C_Container.GetContainerItemID"] = {
    ...
    params = { { name = "containerIndex", type = "BagIndex", default = nil , examples = { { value = "bag", label = "Narcissus_BagFilter" } } }, { name = "slotIndex", type = "luaIndex", default = nil } },
...
APIDefs["C_Container.GetContainerItemInfo"] = {
    ...
    params = { { name = "containerIndex", type = "BagIndex", default = nil , examples = { { value = "item.bagID", label = "Baganator" } } }, { name = "slotIndex", type = "luaIndex", default = nil } },
...
APIDefs["C_Container.GetContainerItemLink"] = {
    ...
    params = { { name = "containerIndex", type = "BagIndex", default = nil , examples = { { value = "arg1", label = "Pawn" }, { value = "id1", label = "Narcissus" } } }, { name = "slotIndex", type = "luaIndex", default = nil } },
...
APIDefs["C_Container.GetContainerNumFreeSlots"] = {
    ...
    params = { { name = "bagIndex", type = "BagIndex", default = nil , examples = { { value = "Syndicator.Constants.AllBankIndexes[self:GetID() + 1]", label = "Baganator" }, { value = "id", label = "BagBrother" } } } },
...
APIDefs["C_Container.GetItemCooldown"] = {
    ...
    params = { { name = "itemID", type = "number", default = nil , examples = { { value = "id", label = "WeakAuras" }, { value = "id", label = "WeakAuras" }, { value = "button.id", label = "Plumber" } } } },
    returns = { { name = "startTime", type = "number", canBeSecret = false }, { name = "duration", type = "number", canBeSecret = false }, { name = "enable", type = "number", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Container.PickupContainerItem"] = {
    ...
    params = { { name = "containerIndex", type = "BagIndex", default = nil , examples = { { value = 0, label = "Baganator" }, { value = "target.bagID", label = "Baganator" }, { value = "move[1]:GetBagAndSlot()", label = "Baganator" } } }, { name = "slotIndex", type = "luaIndex", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Container.SetItemSearch"] = {
    ...
    params = { { name = "searchString", type = "cstring", default = nil , examples = { { value = "", label = "Narcissus_BagFilter" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Container.SocketContainerItem"] = {
    ...
    params = { { name = "containerIndex", type = "BagIndex", default = nil , examples = { { value = "id1", label = "Narcissus" } } }, { name = "slotIndex", type = "luaIndex", default = nil } },
...
APIDefs["C_Container.UseContainerItem"] = {
    ...
    params = { { name = "containerIndex", type = "BagIndex", default = nil , examples = { { value = "item.bagID", label = "Baganator" } } }, { name = "slotIndex", type = "luaIndex", default = nil }, { name = "unitToken", type = "UnitToken", default = "player" }, { name = "bankType", type = "BankType", default = nil }, { name = "reagentBankOpen", type = "bool", default = false } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
