...
APIDefs["C_Item.DoesItemExist"] = {
    ...
    params = { { name = "emptiableItemLocation", type = "EmptiableItemLocation", default = nil , examples = { { value = "item.location", label = "Auctionator" }, { value = "target", label = "Baganator" }, { value = "item", label = "BagBrother" } } } },
...
APIDefs["C_Item.DoesItemExistByID"] = {
    ...
    params = { { name = "itemInfo", type = "ItemInfo", default = nil , examples = { { value = "info[17]", label = "Auctionator" } } } },
    returns = { { name = "itemExists", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Item.DropItemOnUnit"] = {
    ...
    params = { { name = "unitGUID", type = "UnitToken", default = "player" , examples = { { value = "itemName", label = "Details" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Item.GetAppliedItemTransmogInfo"] = {
    ...
    params = { { name = "itemLoc", type = "ItemLocation", default = nil , examples = { { value = "ItemLocation:CreateFromEquipmentSlot(3)", label = "Narcissus" } } } },
...
APIDefs["C_Item.GetCurrentItemLevel"] = {
    ...
    params = { { name = "itemLocation", type = "ItemLocation", default = nil , examples = { { value = "item.location", label = "BagBrother" } } } },
...
APIDefs["C_Item.GetDetailedItemLevelInfo"] = {
    ...
    params = { { name = "itemInfo", type = "ItemInfo", default = nil , examples = { { value = "resultWithKey.entries[1].itemLink", label = "Auctionator" } } } },
...
APIDefs["C_Item.GetItemClassInfo"] = {
    ...
    params = { { name = "itemClassID", type = "number", default = nil , examples = { { value = 20, label = "Syndicator" }, { value = 5, label = "AllTheThings" }, { value = 3, label = "AllTheThings" } } } },
...
APIDefs["C_Item.GetItemCooldown"] = {
    ...
    params = { { name = "itemInfo", type = "ItemInfo", default = nil , examples = { { value = "id", label = "WeakAuras" }, { value = "id", label = "WeakAuras" }, { value = "button.id", label = "Plumber" } } } },
...
APIDefs["C_Item.GetItemCount"] = {
    ...
    params = { { name = "itemInfo", type = "ItemInfo", default = nil , examples = { { value = [=[itemName or ""]=], label = "WeakAuras" }, { value = 194730, label = "Leatrix_Plus" }, { value = 194966, label = "Leatrix_Plus" } } }, { name = "includeBank", type = "bool", default = false }, { name = "includeUses", type = "bool", default = false }, { name = "includeReagentBank", type = "bool", default = false }, { name = "includeAccountBank", type = "bool", default = false } },
...
APIDefs["C_Item.GetItemFamily"] = {
    ...
    params = { { name = "itemInfo", type = "ItemInfo", default = nil , examples = { { value = "item.itemID", label = "Baganator" }, { value = "id", label = "BagBrother" }, { value = "'item:' .. data.link", label = "BagBrother" } } } },
...
APIDefs["C_Item.GetItemGUID"] = {
    ...
    params = { { name = "itemLocation", type = "ItemLocation", default = nil , examples = { { value = "target", label = "Baganator" }, { value = "item", label = "Narcissus" } } } },
...
APIDefs["C_Item.GetItemGem"] = {
    ...
    params = { { name = "hyperlink", type = "cstring", default = nil , examples = { { value = "itemLink", label = "Narcissus" } } }, { name = "index", type = "luaIndex", default = nil } },
...
APIDefs["C_Item.GetItemID"] = {
    ...
    params = { { name = "itemLocation", type = "ItemLocation", default = nil , examples = { { value = "item", label = "Narcissus" } } } },
...
APIDefs["C_Item.GetItemIcon"] = {
    ...
    params = { { name = "itemLocation", type = "ItemLocation", default = nil , examples = { { value = "v[2]", label = "AllTheThings" }, { value = "id", label = "AllTheThings" }, { value = "enchantData[4]", label = "Narcissus" } } } },
    returns = { { name = "icon", type = "fileID", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Item.GetItemIconByID"] = {
    ...
    params = { { name = "itemInfo", type = "ItemInfo", default = nil , examples = { { value = "itemName or ''", label = "WeakAuras" }, { value = "value or ''", label = "WeakAurasOptions" }, { value = "item", label = "Plumber" } } } },
    returns = { { name = "icon", type = "fileID", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Item.GetItemInfo"] = {
    ...
    params = { { name = "itemInfo", type = "ItemInfo", default = nil , examples = { { value = "itemId or 0", label = "WeakAuras" }, { value = "itemname or 0", label = "WeakAuras" }, { value = "trigger.itemName or 0", label = "WeakAuras" } } } },
...
APIDefs["C_Item.GetItemInfoInstant"] = {
    ...
    params = { { name = "itemInfo", type = "ItemInfo", default = nil , examples = { { value = "itemname or 0", label = "WeakAuras" }, { value = "trigger.itemName or 0", label = "WeakAuras" }, { value = "item.itemID", label = "Baganator" } } } },
...
APIDefs["C_Item.GetItemInventoryTypeByID"] = {
    ...
    params = { { name = "itemInfo", type = "ItemInfo", default = nil , examples = { { value = "item.itemID", label = "Baganator" } } } },
    returns = { { name = "inventoryType", type = "InventoryType", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Item.GetItemLink"] = {
    ...
    params = { { name = "itemLocation", type = "ItemLocation", default = nil , examples = { { value = "item", label = "BagBrother" } } } },
    returns = { { name = "itemLink", type = "string", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Item.GetItemLinkByGUID"] = {
    ...
    params = { { name = "itemGUID", type = "WOWGUID", default = nil , examples = { { value = "guid", label = "Auctionator" }, { value = "tooltipData.guid", label = "Plumber" } } } },
    returns = { { name = "itemLink", type = "string", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Item.GetItemMaxStackSizeByID"] = {
    ...
    params = { { name = "itemInfo", type = "ItemInfo", default = nil , examples = { { value = "item.itemID", label = "Baganator" }, { value = "item", label = "Plumber" } } } },
    returns = { { name = "stackSize", type = "number", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Item.GetItemName"] = {
    ...
    params = { { name = "itemLocation", type = "ItemLocation", default = nil , examples = { { value = "id", label = "Narcissus_Database_Item" }, { value = "data[4]", label = "Plumber" }, { value = 228942, label = "Plumber" } } } },
...
APIDefs["C_Item.GetItemNameByID"] = {
    ...
    params = { { name = "itemInfo", type = "ItemInfo", default = nil , examples = { { value = 37705, label = "GatherMate2" }, { value = 22572, label = "GatherMate2" }, { value = "item", label = "Plumber" } } } },
    returns = { { name = "itemName", type = "string", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Item.GetItemNumSockets"] = {
    ...
    params = { { name = "itemInfo", type = "ItemInfo", default = nil , examples = { { value = [=[GetInventoryItemLink("player"]=], label = "Narcissus" } } } },
    returns = { { name = "socketCount", type = "number", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Item.GetItemQualityByID"] = {
    ...
    params = { { name = "itemInfo", type = "ItemInfo", default = nil , examples = { { value = "item.link", label = "BagBrother" } } } },
    returns = { { name = "itemQuality", type = "ItemQuality", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Item.GetItemQualityColor"] = {
    ...
    params = { { name = "quality", type = "ItemQuality", default = nil , examples = { { value = "item.quality", label = "BagBrother" }, { value = "itemQuality or 4", label = "MRT" }, { value = "itemQuality or 1", label = "MRT" } } } },
...
APIDefs["C_Item.GetItemSpell"] = {
    ...
    params = { { name = "itemInfo", type = "ItemInfo", default = nil , examples = { { value = "item", label = "Plumber" } } } },
...
APIDefs["C_Item.GetItemSubClassInfo"] = {
    ...
    params = { { name = "itemClassID", type = "number", default = nil , examples = { { value = 2, label = "WeakAuras" }, { value = 4, label = "WeakAuras" }, { value = 2, label = "AllTheThings" } } }, { name = "itemSubClassID", type = "number", default = nil } },
...
APIDefs["C_Item.GetItemUpgradeInfo"] = {
    ...
    params = { { name = "itemInfo", type = "ItemInfo", default = nil , examples = { { value = "item.itemLink", label = "Baganator" } } } },
...
APIDefs["C_Item.IsCosmeticItem"] = {
    ...
    params = { { name = "itemInfo", type = "ItemInfo", default = nil , examples = { { value = "data.id", label = "Plumber" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Item.IsDecorItem"] = {
    ...
    params = { { name = "itemInfo", type = "ItemInfo", default = nil , examples = { { value = "ItemType: 20", label = "Plumber" } } } },
...
APIDefs["C_Item.IsDressableItemByID"] = {
    ...
    params = { { name = "itemInfo", type = "ItemInfo", default = nil , examples = { { value = "item", label = "Narcissus" }, { value = "id", label = "BagBrother" } } } },
...
APIDefs["C_Item.IsEquippableItem"] = {
    ...
    params = { { name = "itemInfo", type = "ItemInfo", default = nil , examples = { { value = "id", label = "BagBrother" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Item.IsEquippedItem"] = {
    ...
    params = { { name = "itemInfo", type = "ItemInfo", default = nil , examples = { { value = "itemId or ''", label = "WeakAuras" }, { value = "%s or ''", label = "WeakAuras" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Item.IsEquippedItemType"] = {
    ...
    params = { { name = "type", type = "cstring", default = nil , examples = { { value = "Private.ExecEnv.GetItemSubClassInfo(itemType) or ''", label = "WeakAuras" }, { value = "Private.ExecEnv.GetItemSubClassInfo(%s) or ''", label = "WeakAuras" }, { value = "Shields", label = "Plater" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Item.IsItemDataCachedByID"] = {
    ...
    params = { { name = "itemInfo", type = "ItemInfo", default = nil , examples = { { value = "item.itemID", label = "Baganator" }, { value = "self.id", label = "Plumber" } } } },
    returns = { { name = "isCached", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Item.IsItemInRange"] = {
    ...
    params = { { name = "itemInfo", type = "ItemInfo", default = nil , examples = { { value = "state.itemId", label = "WeakAuras" }, { value = "self._state_action", label = "Bartender4" }, { value = "item", label = "BigWigs_Core" } } }, { name = "targetToken", type = "cstring", default = nil } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Item.IsLocked"] = {
    ...
    params = { { name = "itemLocation", type = "ItemLocation", default = nil , examples = { { value = "target", label = "Baganator" }, { value = "move[1]", label = "Baganator" }, { value = "move[2]", label = "Baganator" } } } },
...
APIDefs["C_Item.LockItem"] = {
    ...
    params = { { name = "itemLocation", type = "ItemLocation", default = nil , examples = { { value = [=[LeaMapsCB["UnlockMap"]]=], label = "Leatrix_Maps" }, { value = [=[LeaMapsCB["ScaleWorldMap"]]=], label = "Leatrix_Maps" }, { value = "item", label = "Leatrix_Maps" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Item.PickupItem"] = {
    ...
    params = { { name = "itemInfo", type = "ItemInfo", default = nil , examples = { { value = "target", label = "Bartender4" }, { value = [=["item:"..gemID]=], label = "Narcissus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Item.RequestLoadItemDataByID"] = {
    ...
    params = { { name = "itemInfo", type = "ItemInfo", default = nil , examples = { { value = "item.itemID", label = "Baganator" }, { value = "item", label = "Narcissus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
