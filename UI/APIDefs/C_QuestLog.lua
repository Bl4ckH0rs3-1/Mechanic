...
APIDefs["C_QuestLog.GetInfo"] = {
    ...
    params = { { name = "questLogIndex", type = "luaIndex", default = nil , examples = { { value = "C_QuestLog.GetLogIndexForQuestID(questID) or 0", label = "DBM-WorldEvents" }, { value = "id", label = "Narcissus" } } } },
...
APIDefs["C_QuestLog.GetLogIndexForQuestID"] = {
    ...
    params = { { name = "questID", type = "number", default = nil , examples = { { value = "arg1", label = "Leatrix_Plus" }, { value = "line.id", label = "Plumber" } } } },
...
APIDefs["C_QuestLog.GetQuestObjectives"] = {
    ...
    params = { { name = "questID", type = "number", default = nil , examples = { { value = "id", label = "Weekly" } } } },
...
APIDefs["C_QuestLog.GetTitleForQuestID"] = {
    ...
    params = { { name = "questID", type = "number", default = nil , examples = { { value = "id", label = "AllTheThings" } } } },
    returns = { { name = "title", type = "cstring", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_QuestLog.IsOnQuest"] = {
    ...
    params = { { name = "questID", type = "number", default = nil , examples = { { value = "id", label = "Weekly" }, { value = 13697, label = "AllTheThings" }, { value = 13714, label = "AllTheThings" } } } },
...
APIDefs["C_QuestLog.IsQuestFlaggedCompleted"] = {
    ...
    params = { { name = "questID", type = "number", default = nil , examples = { { value = "id", label = "Weekly" }, { value = "pinInfo[7]", label = "Leatrix_Maps" }, { value = "pinInfo[8]", label = "Leatrix_Maps" } } } },
...
APIDefs["C_QuestLog.IsQuestFlaggedCompletedOnAccount"] = {
    ...
    params = { { name = "questID", type = "number", default = nil , examples = { { value = 86961, label = "Plumber" }, { value = "id", label = "AllTheThings" } } } },
...
APIDefs["C_QuestLog.IsUnitOnQuest"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "Details" } } }, { name = "questID", type = "number", default = nil } },
    returns = { { name = "isOnQuest", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_QuestLog.RequestLoadQuestByID"] = {
    ...
    params = { { name = "questID", type = "number", default = nil , examples = { { value = "arg1", label = "Leatrix_Plus" }, { value = "id", label = "AllTheThings" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
