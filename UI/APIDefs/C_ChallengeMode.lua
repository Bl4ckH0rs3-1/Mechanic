...
APIDefs["C_ChallengeMode.GetAffixInfo"] = {
    ...
    params = { { name = "affixID", type = "number", default = nil , examples = { { value = 1, label = "AstralKeys" } } } },
...
APIDefs["C_ChallengeMode.GetDungeonScoreRarityColor"] = {
    ...
    params = { { name = "dungeonScore", type = "number", default = nil , examples = { { value = "Details222.MythicPlus.NewDungeonScore", label = "Details" }, { value = [=[GetPlayerMythicPlusRatingSummary(LT["Unit"]).currentSeasonScore]=], label = "Leatrix_Plus" } } } },
...
APIDefs["C_ChallengeMode.GetMapUIInfo"] = {
    ...
    params = { { name = "mapChallengeModeID", type = "number", default = nil , examples = { { value = "pData[2]", label = "BigWigs" } } } },
