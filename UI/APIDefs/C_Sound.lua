...
APIDefs["C_Sound.IsPlaying"] = {
    ...
    params = { { name = "soundHandle", type = "number", default = nil , examples = { { value = "target", label = "WaypointUI" }, { value = "self.Caret", label = "WaypointUI" }, { value = "self", label = "WaypointUI" } } } },
...
APIDefs["C_Sound.PlaySound"] = {
    ...
    params = { { name = "soundKitID", type = "number", default = nil , examples = { { value = 856, label = "WeakAurasOptions" }, { value = 857, label = "WeakAurasOptions" }, { value = 852, label = "WeakAurasOptions" } } }, { name = "uiSoundSubType", type = "UISoundSubType", default = "g_defaultSI3UISoundSubTypeForLua" }, { name = "forceNoDuplicates", type = "bool", default = false }, { name = "runFinishCallback", type = "bool", default = false }, { name = "overridePriority", type = "number", default = nil } },
