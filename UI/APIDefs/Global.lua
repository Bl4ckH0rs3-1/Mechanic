...
APIDefs["AddMaskTexture"] = {
    ...
    params = { { name = "mask", type = "SimpleMaskTexture", default = nil , examples = { { value = "f.masks[2]", label = "MRT" }, { value = "f.masks[1]", label = "MRT" }, { value = "mask1", label = "Plumber" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["AddMessage"] = {
    ...
    func = _G["AddMessage"],
    funcPath = "AddMessage",
    params = { { name = "text", type = "cstring", default = nil , examples = { { value = "message", label = "WeakAuras" }, { value = [=["ACP: " .. msg]=], label = "ACP" }, { value = "ERR_NOT_ENOUGH_MONEY", label = "Auctionator" } } }, { name = "colorR", type = "number", default = nil }, { name = "colorG", type = "number", default = nil }, { name = "colorB", type = "number", default = nil }, { name = "a", type = "SingleColorValue", default = nil }, { name = "messageID", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["AddPoint"] = {
    ...
    func = _G["AddPoint"],
    funcPath = "AddPoint",
    params = { { name = "pointX", type = "number", default = nil , examples = { { value = 0, label = "DandersFrames" }, { value = 1, label = "DandersFrames" }, { value = 2, label = "DandersFrames" } } }, { name = "pointY", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["AddUnit"] = {
    ...
    func = _G["AddUnit"],
    funcPath = "AddUnit",
    params = { { name = "unitTokenString", type = "cstring", default = nil , examples = { { value = "unit", label = "AstralKeys" }, { value = "player", label = "Narcissus" } } }, { name = "asset", type = "TextureAssetDisk", default = nil }, { name = "width", type = "uiUnit", default = nil }, { name = "height", type = "uiUnit", default = nil }, { name = "r", type = "number", default = nil }, { name = "g", type = "number", default = nil }, { name = "b", type = "number", default = nil }, { name = "a", type = "number", default = nil }, { name = "sublayer", type = "number", default = nil }, { name = "showFacing", type = "bool", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["AdjustPointsOffset"] = {
    ...
    params = { { name = "x", type = "uiUnit", default = nil , examples = { { value = "-3", label = "Details" }, { value = "-1", label = "Details" }, { value = "-8", label = "Details" } } }, { name = "y", type = "uiUnit", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["Ambiguate"] = {
    ...
    func = _G["Ambiguate"],
    funcPath = "Ambiguate",
    params = { { name = "fullName", type = "cstring", default = nil , examples = { { value = "player", label = "WeakAuras" }, { value = "characterName", label = "WeakAuras" }, { value = "playerNameRealm", label = "AstralKeys" } } }, { name = "context", type = "cstring", default = nil } },
    returns = { { name = "result", type = "string", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["ApplySpellVisualKit"] = {
    ...
    params = { { name = "spellVisualKitID", type = "number", default = nil , examples = { { value = 79517, label = "Narcissus" }, { value = 40277, label = "Narcissus" }, { value = 68828, label = "Narcissus" } } }, { name = "oneShot", type = "bool", default = false } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["AssistUnit"] = {
    ...
    func = _G["AssistUnit"],
    funcPath = "AssistUnit",
    params = { { name = "name", type = "cstring", default = "" , examples = { { value = "unit", label = "Details" } } }, { name = "exactMatch", type = "bool", default = false } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["BreakUpLargeNumbers"] = {
    ...
    params = { { name = "largeNumber", type = "number", default = nil , examples = { { value = "max((base+posBuff+negBuff)", label = "DejaCharacterStats" }, { value = "effectiveAP * GetOverrideSpellPowerByAP() + 0.5", label = "DejaCharacterStats" }, { value = "max(floor(minDamage)", label = "Narcissus" } } }, { name = "natural", type = "bool", default = false } },
    returns = { { name = "result", type = "string", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenTainted",
...
APIDefs["CanInspect"] = {
    ...
    func = _G["CanInspect"],
    funcPath = "CanInspect",
    params = { { name = "targetGUID", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "Narcissus" }, { value = "unit", label = "Narcissus" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["CheckInteractDistance"] = {
    ...
    params = { { name = "unitGUID", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "BigWigs_Plugins" }, { value = "unit", label = "Details" }, { value = "name", label = "MRT" } } }, { name = "distIndex", type = "luaIndex", default = nil } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["ConsoleExec"] = {
    ...
    params = { { name = "command", type = "cstring", default = nil , examples = { { value = "taintLog 0", label = "Leatrix_Plus" }, { value = "taintLog 1", label = "Leatrix_Plus" }, { value = "taintLog 2", label = "Leatrix_Plus" } } }, { name = "addToHistory", type = "bool", default = false } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["ConsoleSetFontHeight"] = {
    ...
    params = { { name = "fontHeightInPixels", type = "number", default = nil , examples = { { value = 28, label = "Leatrix_Plus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["CopyFontObject"] = {
    ...
    params = { { name = "sourceFont", type = "SimpleFont", default = nil , examples = { { value = 'GameFontNormal', label = "Dominos_Config" }, { value = "ZoneTextFont2", label = "Plumber" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["CopyToClipboard"] = {
    ...
    params = { { name = "text", type = "cstring", default = nil , examples = { { value = "all", label = "WeakAurasOptions" }, { value = "display", label = "WeakAurasOptions" }, { value = "display", label = "WeakAurasOptions" } } }, { name = "removeMarkup", type = "bool", default = false } },
...
APIDefs["CreateActor"] = {
    ...
    params = { { name = "name", type = "cstring", default = nil , examples = { { value = "AT", label = "Narcissus" }, { value = nil, label = "Narcissus" }, { value = nil, label = "Narcissus" } } }, { name = "template", type = "cstring", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["CreateAnimation"] = {
    ...
    params = { { name = "animationType", type = "cstring", default = nil , examples = { { value = "rotation", label = "WeakAuras" }, { value = 'Alpha', label = "AstralKeys" }, { value = "Alpha", label = "Baganator" } } }, { name = "name", type = "cstring", default = nil }, { name = "templateName", type = "cstring", default = nil } },
...
APIDefs["CreateAnimationGroup"] = {
    ...
    params = { { name = "name", type = "cstring", default = nil , examples = { { value = "DetailsNewDamageRecordAnimationGroup", label = "Details" }, { value = "DetailsMythicLevelTextAnimationGroup", label = "Details" } } }, { name = "templateName", type = "cstring", default = nil } },
...
APIDefs["CreateControlPoint"] = {
    ...
    params = { { name = "name", type = "cstring", default = nil , examples = { { value = nil, label = "Narcissus" }, { value = nil, label = "Narcissus" } } }, { name = "templateName", type = "cstring", default = nil }, { name = "order", type = "number", default = nil } },
...
APIDefs["CreateWindow"] = {
    ...
    params = { { name = "popupStyle", type = "bool", default = true , examples = { { value = [=[{ 		name = "WeeklyDiscoveryFrame"]=], label = "Weekly" } } }, { name = "topMost", type = "bool", default = false } },
...
APIDefs["EquipItem"] = {
    ...
    func = _G["EquipItem"],
    funcPath = "EquipItem",
    params = { { name = "itemID", type = "number", default = nil , examples = { { value = 111532, label = "Narcissus" }, { value = 130105, label = "Narcissus" }, { value = "weapons[1]", label = "Narcissus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["FocusUnit"] = {
    ...
    func = _G["FocusUnit"],
    funcPath = "FocusUnit",
    params = { { name = "name", type = "cstring", default = "" , examples = { { value = "unit", label = "Details" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["FollowUnit"] = {
    ...
    func = _G["FollowUnit"],
    funcPath = "FollowUnit",
    params = { { name = "name", type = "cstring", default = "0" , examples = { { value = "unit", label = "Details" } } }, { name = "exactMatch", type = "bool", default = false } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["FreezeAnimation"] = {
    ...
    params = { { name = "anim", type = "AnimationDataEnum", default = nil , examples = { { value = 0, label = "Narcissus" }, { value = 1056, label = "Narcissus" }, { value = 4, label = "Narcissus" } } }, { name = "variation", type = "number", default = nil }, { name = "frame", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["GetAddOnMemoryUsage"] = {
    ...
    params = { { name = "name", type = "uiAddon", default = nil , examples = { { value = "Details", label = "Details" }, { value = "Leatrix_Maps", label = "Leatrix_Maps" }, { value = "Leatrix_Plus", label = "Leatrix_Plus" } } } },
    returns = { { name = "result", type = "number", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["GetComboPoints"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" }, { value = "player", label = "Plater" } } }, { name = "target", type = "UnitToken", default = "player" } },
    returns = { { name = "result", type = "number", canBeSecret = false } },
    midnightImpact = "CONDITIONAL",
...
APIDefs["GetDifficultyInfo"] = {
    ...
    params = { { name = "difficultyID", type = "number", default = nil , examples = { { value = 3, label = "AllTheThings" }, { value = 7, label = "AllTheThings" }, { value = 1, label = "AllTheThings" } } } },
...
APIDefs["GetFileIDFromPath"] = {
    ...
    params = { { name = "filePath", type = "cstring", default = nil , examples = { { value = 'Interface/Buttons/UI-MinusButton-Up', label = "BagBrother" } } } },
...
APIDefs["GetPlayerInfoByGUID"] = {
    ...
    params = { { name = "guid", type = "WOWGUID", default = nil , examples = { { value = "guid", label = "AllTheThings" }, { value = "id", label = "AllTheThings" }, { value = [=[self.serial or ""]=], label = "Details" } } } },
...
APIDefs["GetPoint"] = {
    ...
    func = _G["GetPoint"],
    funcPath = "GetPoint",
    params = { { name = "anchorIndex", type = "luaIndex", default = 0 , examples = { { value = 1, label = "WeakAuras" }, { value = 2, label = "DejaCharacterStats" } } }, { name = "resolveCollapsed", type = "bool", default = false } },
...
APIDefs["GetPointByName"] = {
    ...
    params = { { name = "point", type = "FramePoint", default = nil , examples = { { value = "LEFT", label = "AllTheThings" }, { value = "TOPLEFT", label = "Auctionator" } } }, { name = "resolveCollapsed", type = "bool", default = false } },
    returns = { { name = "point", type = "FramePoint", canBeSecret = false }, { name = "relativeTo", type = "ScriptRegion", canBeSecret = false }, { name = "relativePoint", type = "FramePoint", canBeSecret = false }, { name = "offsetX", type = "uiUnit", canBeSecret = false }, { name = "offsetY", type = "uiUnit", canBeSecret = false } },
    midnightImpact = "CONDITIONAL",
    midnightNote = "Secret behavior: SecretWhenAnchoringSecret, SecretArguments=AllowedWhenUntainted",
}
...
APIDefs["GetRaidTargetIndex"] = {
    ...
    params = { { name = "target", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" }, { value = "player", label = "BigWigs_Plugins" }, { value = "frame.unit", label = "DandersFrames" } } } },
...
APIDefs["GetRealZoneText"] = {
    ...
    params = { { name = "mapID", type = "number", default = nil , examples = { { value = "id", label = "BigWigs" }, { value = "teleport[1]", label = "DBM-Core" }, { value = "tonumber(string.sub(name", label = "DBM-Core" } } } },
...
APIDefs["GetRuneCooldown"] = {
    ...
    params = { { name = "runeIndex", type = "luaIndex", default = nil , examples = { { value = "id", label = "WeakAuras" }, { value = 1, label = "DejaCharacterStats" } } } },
...
APIDefs["GetScript"] = {
    ...
    func = _G["GetScript"],
    funcPath = "GetScript",
    params = { { name = "scriptTypeName", type = "cstring", default = nil , examples = { { value = "OnEvent", label = "WeakAuras" }, { value = "OnTextSet", label = "WeakAurasOptions" }, { value = "OnTextChanged", label = "WeakAurasOptions" } } }, { name = "bindingType", type = "number", default = nil } },
...
APIDefs["GetSpecializationInfoForClassID"] = {
    ...
    params = { { name = "classID", type = "number", default = nil , examples = { { value = "classID", label = "Plater" }, { value = "classID", label = "Plater" }, { value = "classID", label = "TalentTreeTweaks" } } }, { name = "index", type = "luaIndex", default = nil }, { name = "gender", type = "UnitSex", default = nil } },
...
APIDefs["GetTitleName"] = {
    ...
    params = { { name = "titleMaskID", type = "number", default = nil , examples = { { value = "id", label = "Plumber" } } } },
...
APIDefs["GetUnitChargedPowerPoints"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = 'player', label = "WeakAuras" }, { value = "player", label = "Plater" } } } },
...
APIDefs["GetUnitEmpowerHoldAtMaxTime"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" }, { value = "self.unit", label = "Plater" } } } },
...
APIDefs["GetUnitEmpowerStageDuration"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" } } }, { name = "index", type = "number", default = nil } },
...
APIDefs["GetUnitMaxHealthModifier"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = 'player', label = "WeakAuras" }, { value = "player", label = "Narcissus" } } } },
    returns = { { name = "result", type = "number", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["GetUnitPowerBarStrings"] = {
    ...
    params = { { name = "unitToken", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" } } } },
...
APIDefs["GetUnitPowerBarTextureInfo"] = {
    ...
    params = { { name = "unitToken", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" } } }, { name = "textureIndex", type = "luaIndex", default = nil }, { name = "timerIndex", type = "luaIndex", default = nil } },
...
APIDefs["GetUnitSpeed"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "player", label = "WeakAuras" }, { value = 'player', label = "WeakAuras" }, { value = "unit", label = "DejaCharacterStats" } } } },
...
APIDefs["HasAnimation"] = {
    ...
    params = { { name = "anim", type = "AnimationDataEnum", default = nil , examples = { { value = "id", label = "Narcissus" } } } },
...
APIDefs["HasScript"] = {
    ...
    func = _G["HasScript"],
    funcPath = "HasScript",
    params = { { name = "scriptName", type = "cstring", default = nil , examples = { { value = "OnMouseDown", label = "MoveAny" }, { value = "OnMouseUp", label = "MoveAny" }, { value = "OnTooltipAddMoney", label = "Narcissus" } } } },
...
APIDefs["HookScript"] = {
    ...
    func = _G["HookScript"],
    funcPath = "HookScript",
    params = { { name = "scriptTypeName", type = "cstring", default = nil , examples = { { value = "OnSizeChanged", label = "WeakAuras" }, { value = "OnVerticalScroll", label = "WeakAurasOptions" }, { value = "OnScrollRangeChanged", label = "WeakAurasOptions" } } }, { name = "script", type = "luaFunction", default = nil }, { name = "bindingType", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["IsFalling"] = {
    ...
    func = _G["IsFalling"],
    funcPath = "IsFalling",
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "DejaCharacterStats" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["IsFlying"] = {
    ...
    func = _G["IsFlying"],
    funcPath = "IsFlying",
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "DejaCharacterStats" }, { value = "player", label = "Narcissus" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["IsKeyDown"] = {
    ...
    func = _G["IsKeyDown"],
    funcPath = "IsKeyDown",
    params = { { name = "keyOrMouseName", type = "cstring", default = nil , examples = { { value = "BACKSPACE", label = "Narcissus" } } }, { name = "excludeBindingState", type = "bool", default = false } },
...
APIDefs["IsMouseButtonDown"] = {
    ...
    params = { { name = "button", type = "mouseButton", default = nil , examples = { { value = "LeftButton", label = "WeakAurasOptions" }, { value = "RightButton", label = "WeakAurasOptions" }, { value = "MiddleButton", label = "MoveAny" } } } },
    returns = { { name = "down", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["IsMoviePlayable"] = {
    ...
    params = { { name = "movieId", type = "number", default = nil , examples = { { value = "arg1", label = "Leatrix_Plus" } } } },
...
APIDefs["IsUnitModelReadyForUI"] = {
    ...
    params = { { name = "unitToken", type = "UnitToken", default = "player" , examples = { { value = "player", label = "Narcissus_Barbershop" } } } },
...
APIDefs["Mixin"] = {
    ...
    func = _G["Mixin"],
    funcPath = "Mixin",
    params = { { name = "object", type = "LuaValueVariant", default = nil , examples = { { value = [=[{   player = L["Player"]]=], label = "WeakAuras" }, { value = [=[{   player = L["Player"]]=], label = "WeakAuras" }, { value = [=[{   player = L["Player"]]=], label = "WeakAuras" } } }, { name = "mixins", type = "LuaValueVariant", default = nil } },
...
APIDefs["NotifyInspect"] = {
    ...
    params = { { name = "targetGUID", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "Narcissus" }, { value = "player", label = "Narcissus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["Play"] = {
    ...
    func = _G["Play"],
    funcPath = "Play",
    params = { { name = "reverse", type = "bool", default = false , examples = { { value = "helpspirit", label = "DBM-Affixes" }, { value = "targetchange", label = "DBM-Affixes" }, { value = "range5", label = "DBM-Affixes" } } }, { name = "offset", type = "number", default = 0 } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["PlayAnimKit"] = {
    ...
    params = { { name = "animKit", type = "number", default = nil , examples = { { value = "id", label = "Narcissus" } } }, { name = "loop", type = "bool", default = false } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["PlayAnimationKit"] = {
    ...
    params = { { name = "animationKit", type = "number", default = nil , examples = { { value = 0, label = "Narcissus" } } }, { name = "isLooping", type = "bool", default = false } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["Project3DPointTo2D"] = {
    ...
    params = { { name = "pointX", type = "number", default = nil , examples = { { value = 0, label = "Narcissus" }, { value = "x", label = "Narcissus" }, { value = "x", label = "Narcissus" } } }, { name = "pointY", type = "number", default = nil }, { name = "pointZ", type = "number", default = nil } },
...
APIDefs["RandomRoll"] = {
    ...
    func = _G["RandomRoll"],
    funcPath = "RandomRoll",
    params = { { name = "min", type = "number", default = nil , examples = { { value = 1, label = "TitanLootType" }, { value = 1, label = "TitanLootType" } } }, { name = "max", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["RegisterEventCallback"] = {
    ...
    params = { { name = "eventName", type = "cstring", default = nil , examples = { { value = "HOUSE_LEVEL_FAVOR_UPDATED", label = "Plumber" }, { value = "PLAYER_HOUSE_LIST_UPDATED", label = "Plumber" } } }, { name = "callback", type = "EventCallbackType", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["Restart"] = {
    ...
    func = _G["Restart"],
    funcPath = "Restart",
    params = { { name = "reverse", type = "bool", default = false , examples = { { value = 6, label = "DBM-Party-Dragonflight" }, { value = "15.7", label = "DBM-Party-Dragonflight" } } }, { name = "offset", type = "number", default = 0 } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["RunScript"] = {
    ...
    func = _G["RunScript"],
    funcPath = "RunScript",
    params = { { name = "text", type = "cstring", default = nil , examples = { { value = [=["hooksecurefunc('OpenAllBags']=], label = "Leatrix_Plus" }, { value = 'ShowUIPanel(EditModeManagerFrame)', label = "Leatrix_Plus" }, { value = "btn:GetParent()", label = "TalentTreeTweaks" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetAllPoints"] = {
    ...
    params = { { name = "relativeTo", type = "ScriptRegion", default = nil , examples = { { value = "_G[menu:GetName() .. 'TitleBG']", label = "Dominos_Config" }, { value = [=[LeaPlusLC["PageF"]]=], label = "Leatrix_Plus" }, { value = "DebuffButton1", label = "MoveAny" } } }, { name = "doResize", type = "bool", default = true } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetAlpha"] = {
    ...
    func = _G["SetAlpha"],
    funcPath = "SetAlpha",
    params = { { name = "alpha", type = "SingleColorValue", default = nil , examples = { { value = "0.8", label = "WeakAuras" }, { value = "region.color_anim_a or a or 1", label = "WeakAuras" }, { value = "a or region.color_a or 1", label = "WeakAuras" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetAnimation"] = {
    ...
    params = { { name = "animation", type = "AnimationDataEnum", default = nil , examples = { { value = 0, label = "WeakAuras" }, { value = "animTable[setting]", label = "Leatrix_Plus" }, { value = [=[animTable[math.floor(LeaPlusCB["DressupAnim"]:GetValue() + 0.5)]]=], label = "Leatrix_Plus" } } }, { name = "variation", type = "number", default = nil }, { name = "animSpeed", type = "number", default = 1 }, { name = "animOffsetSeconds", type = "number", default = 0 } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetAnimationBlendOperation"] = {
    ...
    params = { { name = "blendOp", type = "ModelBlendOperation", default = nil , examples = { { value = 0, label = "Narcissus" }, { value = 1, label = "Narcissus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetArchBlobRingScalar"] = {
    ...
    params = { { name = "scalar", type = "number", default = nil , examples = { { value = 0, label = "ClassyMap" }, { value = 1, label = "ClassyMap" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetBorderTexture"] = {
    ...
    params = { { name = "asset", type = "FileAsset", default = nil , examples = { { value = "border", label = "Narcissus" }, { value = "self.Border", label = "Narcissus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetCamDistanceScale"] = {
    ...
    params = { { name = "scale", type = "number", default = nil , examples = { { value = "1.7", label = "AllTheThings" }, { value = "0.8", label = "AllTheThings" }, { value = "reference.modelScale or 1", label = "AllTheThings" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetCamera"] = {
    ...
    func = _G["SetCamera"],
    funcPath = "SetCamera",
    params = { { name = "cameraIndex", type = "number", default = nil , examples = { { value = 0, label = "Narcissus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetCameraFieldOfView"] = {
    ...
    params = { { name = "fov", type = "number", default = nil , examples = { { value = "0.75", label = "Narcissus" }, { value = "camInfo[1]", label = "Narcissus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetCameraOrientationByAxisVectors"] = {
    ...
    params = { { name = "forwardX", type = "number", default = nil , examples = { { value = "-1", label = "Narcissus" }, { value = "camInfo[5]", label = "Narcissus" } } }, { name = "forwardY", type = "number", default = nil }, { name = "forwardZ", type = "number", default = nil }, { name = "rightX", type = "number", default = nil }, { name = "rightY", type = "number", default = nil }, { name = "rightZ", type = "number", default = nil }, { name = "upX", type = "number", default = nil }, { name = "upY", type = "number", default = nil }, { name = "upZ", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetCameraOrientationByYawPitchRoll"] = {
    ...
    params = { { name = "yaw", type = "number", default = nil , examples = { { value = "PI", label = "Narcissus" }, { value = "math.pi", label = "Narcissus" }, { value = "self.yaw", label = "Narcissus" } } }, { name = "pitch", type = "number", default = nil }, { name = "roll", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetCameraPosition"] = {
    ...
    params = { { name = "positionX", type = "number", default = nil , examples = { { value = "3.84", label = "Narcissus" }, { value = "NarciNPCModelFrame2:GetCameraPosition()", label = "Narcissus" }, { value = 10, label = "Narcissus" } } }, { name = "positionY", type = "number", default = nil }, { name = "positionZ", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetCameraTarget"] = {
    ...
    params = { { name = "targetX", type = "number", default = nil , examples = { { value = 0, label = "Narcissus" } } }, { name = "targetY", type = "number", default = nil }, { name = "targetZ", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetChecked"] = {
    ...
    func = _G["SetChecked"],
    funcPath = "SetChecked",
    params = { { name = "checked", type = "bool", default = false , examples = { { value = [=[settings:Get("Skip:AutoRefresh")]=], label = "AllTheThings" }, { value = [=[settings:GetTooltipSetting("Channel") == "Master"]=], label = "AllTheThings" }, { value = [=[settings:GetTooltipSetting("Channel") == "Music"]=], label = "AllTheThings" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetCheckedTexture"] = {
    ...
    params = { { name = "asset", type = "TextureAsset", default = nil , examples = { { value = [=[app.asset("TrackAccountWide")]=], label = "AllTheThings" }, { value = "_G[name .. 'Check']", label = "BagBrother" }, { value = "template.checked_texture", label = "Plater" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetChildKey"] = {
    ...
    params = { { name = "childKey", type = "cstring", default = nil , examples = { { value = 'flash', label = "BagBrother" }, { value = "TextObj", label = "MRT" }, { value = "target", label = "MRT" } } } },
    returns = { { name = "success", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetCollected"] = {
    ...
    params = { { name = "isActive", type = "bool", default = nil , examples = { { value = "t", label = "AllTheThings" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetColorHSV"] = {
    ...
    params = { { name = "hsvX", type = "number", default = nil , examples = { { value = "h3", label = "WeakAuras" } } }, { name = "hsvY", type = "number", default = nil }, { name = "hsvZ", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=NotAllowed",
...
APIDefs["SetColorRGB"] = {
    ...
    params = { { name = "rgbR", type = "number", default = nil , examples = { { value = "r1", label = "WeakAuras" }, { value = "r2", label = "WeakAuras" }, { value = 1, label = "Baganator" } } }, { name = "rgbG", type = "number", default = nil }, { name = "rgbB", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=NotAllowed",
...
APIDefs["SetColorValueThumbTexture"] = {
    ...
    params = { { name = "texture", type = "TextureAsset", default = nil , examples = { { value = "colorTexture2", label = "DBM-GUI" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetCreature"] = {
    ...
    params = { { name = "creatureID", type = "number", default = nil , examples = { { value = "id", label = "AllTheThings" }, { value = "tonumber(creatureid) or 448", label = "DBM-GUI" }, { value = "self.id", label = "Narcissus" } } }, { name = "displayID", type = "number", default = 0 } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetCursor"] = {
    ...
    func = _G["SetCursor"],
    funcPath = "SetCursor",
    params = { { name = "name", type = "cstring", default = nil , examples = { { value = "CAST_CURSOR", label = "WeakAurasOptions" }, { value = "Interface/Cursor/Buy.blp", label = "Baganator" }, { value = "Interface/CURSOR/Item.blp", label = "Narcissus" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetCursorPosition"] = {
    ...
    params = { { name = "xPosition", type = "uiUnit", default = nil , examples = { { value = 0, label = "WeakAurasOptions" }, { value = "self.timeMachine[self.timeMachinePos][2]", label = "WeakAurasOptions" }, { value = "editor.editBox:GetCursorPosition() - 1", label = "WeakAurasOptions" } } }, { name = "yPosition", type = "uiUnit", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetCurveType"] = {
    ...
    params = { { name = "curveType", type = "CurveType", default = nil , examples = { { value = "SMOOTH", label = "Narcissus" }, { value = [=[arg4 or "SMOOTH"]=], label = "Plater" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetDamageAbsorbClampMode"] = {
    ...
    params = { { name = "damageAbsorbClampMode", type = "UnitDamageAbsorbClampMode", default = nil , examples = { { value = 2, label = "DandersFrames" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=NotAllowed",
...
APIDefs["SetDegrees"] = {
    ...
    func = _G["SetDegrees"],
    funcPath = "SetDegrees",
    params = { { name = "angle", type = "number", default = nil , examples = { { value = "-360", label = "WeakAurasOptions" }, { value = 360, label = "Details" }, { value = 20, label = "Details" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetDesaturation"] = {
    ...
    params = { { name = "strength", type = "number", default = nil , examples = { { value = "0.5", label = "Baganator" }, { value = 1, label = "Baganator" }, { value = "self.icon", label = "Bartender4" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetDisplayInfo"] = {
    ...
    params = { { name = "displayID", type = "number", default = nil , examples = { { value = 0, label = "AllTheThings" }, { value = 987, label = "AllTheThings" }, { value = "displayInfos[1]", label = "AllTheThings" } } }, { name = "mountDisplayID", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetDrawLayer"] = {
    ...
    params = { { name = "layer", type = "DrawLayer", default = nil , examples = { { value = "ARTWORK", label = "WeakAuras" }, { value = "ARTWORK", label = "WeakAuras" }, { value = "ARTWORK", label = "WeakAuras" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetDungeonDifficultyID"] = {
    ...
    params = { { name = "difficultyID", type = "number", default = nil , examples = { { value = 1, label = "TitanLootType" }, { value = 2, label = "TitanLootType" }, { value = 23, label = "TitanLootType" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetDuration"] = {
    ...
    params = { { name = "durationSec", type = "number", default = nil , examples = { { value = 0, label = "WeakAuras" }, { value = 1, label = "WeakAurasOptions" }, { value = ".12", label = "AstralKeys" } } }, { name = "recomputeGroupDuration", type = "bool", default = true } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetEnabled"] = {
    ...
    func = _G["SetEnabled"],
    funcPath = "SetEnabled",
    params = { { name = "enabled", type = "bool", default = nil , examples = { { value = "self.currentIndex > 1", label = "!Mechanic" }, { value = "#AUCTIONATOR_SELLING_GROUPS.HiddenItems ~= 0", label = "Auctionator" }, { value = "self.selectedAuctionData ~= nil and self.selectedAuctionData.isOwned and self.selectedAuctionData.numStacks > 0 and Auctionator.AH.IsNotThrottled()", label = "Auctionator" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetEndColor"] = {
    ...
    params = { { name = "color", type = "colorRGBA", default = nil , examples = { { value = "CreateColor(r2", label = "Plater" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenTainted",
...
APIDefs["SetEndDelay"] = {
    ...
    params = { { name = "delaySec", type = "number", default = nil , examples = { { value = 2147483647, label = "WeakAuras" }, { value = "0.4", label = "BigWigs_Plugins" }, { value = 0, label = "Details" } } }, { name = "recomputeGroupDuration", type = "bool", default = true } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=NotAllowed",
...
APIDefs["SetEndPoint"] = {
    ...
    params = { { name = "relativePoint", type = "FramePoint", default = nil , examples = { { value = "BOTTOMRIGHT", label = "WeakAurasOptions" }, { value = "BOTTOMLEFT", label = "WeakAurasOptions" }, { value = "BOTTOMLEFT", label = "WeakAurasOptions" } } }, { name = "relativeTo", type = "ScriptRegion", default = nil }, { name = "offsetX", type = "uiUnit", default = 0 }, { name = "offsetY", type = "uiUnit", default = 0 } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetFacing"] = {
    ...
    func = _G["SetFacing"],
    funcPath = "SetFacing",
    params = { { name = "facing", type = "number", default = nil , examples = { { value = "mod.modelRotation or 0", label = "DBM-GUI" }, { value = 0, label = "Narcissus" }, { value = "math.pi/6", label = "Narcissus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetFading"] = {
    ...
    func = _G["SetFading"],
    funcPath = "SetFading",
    params = { { name = "fading", type = "bool", default = nil , examples = { { value = "-4", label = "Narcissus" }, { value = 4, label = "Narcissus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetFlipBookColumns"] = {
    ...
    params = { { name = "columns", type = "number", default = nil , examples = { { value = "Style.Columns or 5", label = "Masque" }, { value = 5, label = "Masque" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetFlipBookFrameHeight"] = {
    ...
    params = { { name = "height", type = "number", default = nil , examples = { { value = 0, label = "Masque" }, { value = "Style.FrameHeight or 0", label = "Masque" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetFlipBookFrameWidth"] = {
    ...
    params = { { name = "width", type = "number", default = nil , examples = { { value = 0, label = "Masque" }, { value = "Style.FrameWidth or 0", label = "Masque" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetFlipBookFrames"] = {
    ...
    params = { { name = "frames", type = "number", default = nil , examples = { { value = "Style.Frames or 30", label = "Masque" }, { value = 30, label = "Masque" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetFlipBookRows"] = {
    ...
    params = { { name = "rows", type = "number", default = nil , examples = { { value = "Style.Rows or 6", label = "Masque" }, { value = 6, label = "Masque" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetFogColor"] = {
    ...
    params = { { name = "colorR", type = "number", default = nil , examples = { { value = 1, label = "Narcissus" }, { value = "0.13", label = "Narcissus" } } }, { name = "colorG", type = "number", default = nil }, { name = "colorB", type = "number", default = nil }, { name = "a", type = "SingleColorValue", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetFogFar"] = {
    ...
    func = _G["SetFogFar"],
    funcPath = "SetFogFar",
    params = { { name = "fogFar", type = "number", default = nil , examples = { { value = "0.1", label = "Narcissus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetFogNear"] = {
    ...
    func = _G["SetFogNear"],
    funcPath = "SetFogNear",
    params = { { name = "fogNear", type = "number", default = nil , examples = { { value = 0, label = "Narcissus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetFont"] = {
    ...
    func = _G["SetFont"],
    funcPath = "SetFont",
    params = { { name = "fontFile", type = "cstring", default = nil , examples = { { value = "fontPath", label = "WeakAuras" }, { value = "STANDARD_TEXT_FONT", label = "WeakAuras" }, { value = "fontPath", label = "WeakAuras" } } }, { name = "height", type = "uiFontHeight", default = nil }, { name = "flags", type = "TBFFlags", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetFontObject"] = {
    ...
    params = { { name = "font", type = "SimpleFont", default = nil , examples = { { value = "GameFontNormalSmall2", label = "WeakAurasOptions" }, { value = "GameFontNormalSmall", label = "WeakAurasOptions" }, { value = "GameFontNormal", label = "WeakAurasOptions" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetFromAlpha"] = {
    ...
    params = { { name = "normalizedAlpha", type = "number", default = nil , examples = { { value = 1, label = "AstralKeys" }, { value = 0, label = "AstralKeys" }, { value = "0.4", label = "Baganator" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=NotAllowed",
...
APIDefs["SetHealAbsorbClampMode"] = {
    ...
    params = { { name = "healAbsorbClampMode", type = "UnitHealAbsorbClampMode", default = nil , examples = { { value = 0, label = "DandersFrames" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=NotAllowed",
...
APIDefs["SetHeight"] = {
    ...
    func = _G["SetHeight"],
    funcPath = "SetHeight",
    params = { { name = "height", type = "uiUnit", default = nil , examples = { { value = 1, label = "WeakAuras" }, { value = 32, label = "WeakAuras" }, { value = "show and (yProgress + 0.1) or 0.1", label = "WeakAuras" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetIncomingHealOverflowPercent"] = {
    ...
    params = { { name = "incomingHealOverflowPercent", type = "number", default = nil , examples = { { value = "1.0", label = "DandersFrames" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=NotAllowed",
...
APIDefs["SetItem"] = {
    ...
    func = _G["SetItem"],
    funcPath = "SetItem",
    params = { { name = "itemID", type = "number", default = nil , examples = { { value = "dbKeys[1]", label = "Auctionator" }, { value = "Auctionator.Utilities.DBKeyFromBrowseResult({ itemKey = itemInfo.itemKey })[1]", label = "Auctionator" }, { value = "itemInfo[1]", label = "Narcissus" } } }, { name = "appearanceModID", type = "number", default = nil }, { name = "itemVisualID", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetItemAppearance"] = {
    ...
    params = { { name = "itemAppearanceID", type = "number", default = nil , examples = { { value = 69893, label = "Narcissus" } } }, { name = "itemVisualID", type = "number", default = nil }, { name = "itemSubclass", type = "ItemWeaponSubclass", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetItemTransmogInfo"] = {
    ...
    params = { { name = "transmogInfo", type = "ItemTransmogInfo", default = nil , examples = { { value = "transmogInfo", label = "Narcissus" }, { value = "mainHandInfo", label = "Narcissus" }, { value = "offHandInfo", label = "Narcissus" } } }, { name = "inventorySlots", type = "number", default = nil }, { name = "ignoreChildItems", type = "bool", default = false } },
...
APIDefs["SetJustifyH"] = {
    ...
    params = { { name = "justifyH", type = "JustifyHorizontal", default = nil , examples = { { value = "LEFT", label = "WeakAuras" }, { value = [=[data.text_justify or "CENTER"]=], label = "WeakAuras" }, { value = "CENTER", label = "WeakAurasOptions" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetJustifyV"] = {
    ...
    params = { { name = "justifyV", type = "JustifyVertical", default = nil , examples = { { value = "TOP", label = "WeakAuras" }, { value = "MIDDLE", label = "WeakAurasOptions" }, { value = 'TOP', label = "Bartender4" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetLight"] = {
    ...
    func = _G["SetLight"],
    funcPath = "SetLight",
    params = { { name = "enabled", type = "bool", default = nil , examples = { { value = true, label = "Narcissus" }, { value = true, label = "Narcissus" }, { value = true, label = "Narcissus" } } }, { name = "light", type = "ModelLight", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetLightAmbientColor"] = {
    ...
    params = { { name = "colorR", type = "number", default = nil , examples = { { value = "0.6", label = "Narcissus" } } }, { name = "colorG", type = "number", default = nil }, { name = "colorB", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetLightDiffuseColor"] = {
    ...
    params = { { name = "colorR", type = "number", default = nil , examples = { { value = "0.78", label = "Narcissus" }, { value = "0.8", label = "Narcissus" } } }, { name = "colorG", type = "number", default = nil }, { name = "colorB", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetLightDirection"] = {
    ...
    params = { { name = "directionX", type = "number", default = nil , examples = { { value = "-1", label = "Narcissus" }, { value = "-0.0655", label = "Narcissus_Achievements" } } }, { name = "directionY", type = "number", default = nil }, { name = "directionZ", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetLightPosition"] = {
    ...
    params = { { name = "positionX", type = "number", default = nil , examples = { { value = 1, label = "Narcissus" } } }, { name = "positionY", type = "number", default = nil }, { name = "positionZ", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetLightType"] = {
    ...
    params = { { name = "lightType", type = "ModelLightType", default = nil , examples = { { value = 1, label = "Narcissus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetLooping"] = {
    ...
    func = _G["SetLooping"],
    funcPath = "SetLooping",
    params = { { name = "loopType", type = "LoopType", default = nil , examples = { { value = "REPEAT", label = "Baganator" }, { value = "repeat", label = "Details" }, { value = "NONE", label = "Details" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=NotAllowed",
...
APIDefs["SetLootSpecialization"] = {
    ...
    params = { { name = "specializationID", type = "number", default = nil , examples = { { value = "row.ref.id", label = "AllTheThings" }, { value = 0, label = "AllTheThings" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetMapID"] = {
    ...
    func = _G["SetMapID"],
    funcPath = "SetMapID",
    params = { { name = "uiMapID", type = "number", default = nil , examples = { { value = "tonumber(cmd:sub(7))", label = "AllTheThings" }, { value = "arg1", label = "Leatrix_Maps" }, { value = "tonumber(arg1)", label = "Leatrix_Maps" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetMaskTexture"] = {
    ...
    params = { { name = "asset", type = "TextureAsset", default = nil , examples = { { value = "Interface\\BUTTONS\\WHITE8X8", label = "ClassyMap" }, { value = "Textures\\MinimapMask", label = "ClassyMap" }, { value = 'Interface\\ChatFrame\\ChatFrameBackground', label = "Leatrix_Plus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetMinMaxValues"] = {
    ...
    params = { { name = "minValue", type = "number", default = nil , examples = { { value = 0, label = "WeakAuras" }, { value = 0, label = "WeakAurasOptions" }, { value = 0, label = "WeakAurasOptions" } } }, { name = "maxValue", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetModel"] = {
    ...
    func = _G["SetModel"],
    funcPath = "SetModel",
    params = { { name = "asset", type = "ModelAsset", default = nil , examples = { { value = "self.id", label = "Narcissus" }, { value = 124640, label = "Narcissus" } } }, { name = "noMip", type = "bool", default = false } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetModelAlpha"] = {
    ...
    params = { { name = "alpha", type = "number", default = nil , examples = { { value = 1, label = "Narcissus" }, { value = "f.t * 4", label = "Narcissus" }, { value = 0, label = "Narcissus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetModelByCreatureDisplayID"] = {
    ...
    params = { { name = "creatureDisplayID", type = "number", default = nil , examples = { { value = "id", label = "Narcissus" } } }, { name = "useActivePlayerCustomizations", type = "bool", default = false } },
    returns = { { name = "success", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetModelByFileID"] = {
    ...
    params = { { name = "asset", type = "FileAsset", default = nil , examples = { { value = 611777, label = "Narcissus" }, { value = 1567107, label = "Narcissus" }, { value = 916495, label = "Narcissus" } } }, { name = "useMips", type = "bool", default = false } },
    returns = { { name = "success", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetModelDrawLayer"] = {
    ...
    params = { { name = "layer", type = "DrawLayer", default = nil , examples = { { value = "ARTWORK", label = "Narcissus" }, { value = "BACKGROUND", label = "Narcissus" }, { value = "BACKGROUND", label = "Narcissus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetModelScale"] = {
    ...
    params = { { name = "scale", type = "number", default = nil , examples = { { value = 1, label = "DBM-GUI" }, { value = "0.85", label = "DBM-Party-BC" }, { value = "0.5", label = "DBM-Party-BC" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetOffset"] = {
    ...
    func = _G["SetOffset"],
    funcPath = "SetOffset",
    params = { { name = "offsetX", type = "uiUnit", default = nil , examples = { { value = "data.xOffset or 0", label = "WeakAuras" }, { value = 0, label = "Bartender4" }, { value = 200, label = "Details" } } }, { name = "offsetY", type = "uiUnit", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetOrder"] = {
    ...
    func = _G["SetOrder"],
    funcPath = "SetOrder",
    params = { { name = "order", type = "number", default = nil , examples = { { value = 1, label = "Baganator" }, { value = 2, label = "Baganator" }, { value = "i * 2", label = "BagBrother" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetOrientation"] = {
    ...
    params = { { name = "orientation", type = "Orientation", default = nil , examples = { { value = "VERTICAL_INVERSE", label = "WeakAuras" }, { value = "VERTICAL", label = "WeakAuras" }, { value = "data.linearTextureOrientation", label = "WeakAuras" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetOrigin"] = {
    ...
    func = _G["SetOrigin"],
    funcPath = "SetOrigin",
    params = { { name = "point", type = "FramePoint", default = nil , examples = { { value = "anchor", label = "WeakAuras" }, { value = "center", label = "Details" }, { value = "RIGHT", label = "Details" } } }, { name = "originX", type = "number", default = nil }, { name = "originY", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetParent"] = {
    ...
    func = _G["SetParent"],
    funcPath = "SetParent",
    params = { { name = "parent", type = "SimplePathAnim", default = nil , examples = { { value = "Bartender4.UIHider", label = "Bartender4" }, { value = [=[_G[window:GetName() .. "TitleBar"]]=], label = "Details" }, { value = "window1.baseframe", label = "Details" } } }, { name = "order", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetPitch"] = {
    ...
    func = _G["SetPitch"],
    funcPath = "SetPitch",
    params = { { name = "pitch", type = "number", default = nil , examples = { { value = 0, label = "Narcissus" }, { value = "pi/2", label = "Narcissus" }, { value = "modelInfo[7]", label = "Narcissus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetPlayerPingTexture"] = {
    ...
    params = { { name = "textureType", type = "PingTextureType", default = nil , examples = { { value = "Enum.PingTextureType.Center", label = "Plumber" }, { value = "Enum.PingTextureType.Expand", label = "Plumber" }, { value = "Enum.PingTextureType.Rotation", label = "Plumber" } } }, { name = "asset", type = "FileAsset", default = nil }, { name = "width", type = "uiUnit", default = 0 }, { name = "height", type = "uiUnit", default = 0 } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetPoint"] = {
    ...
    func = _G["SetPoint"],
    funcPath = "SetPoint",
    params = { { name = "point", type = "FramePoint", default = nil , examples = { { value = "TOPRIGHT", label = "WeakAuras" }, { value = "TOPLEFT", label = "WeakAuras" }, { value = "TOPLEFT", label = "WeakAuras" } } }, { name = "relativeTo", type = "ScriptRegion", default = nil }, { name = "relativePoint", type = "FramePoint", default = nil }, { name = "offsetX", type = "uiUnit", default = nil }, { name = "offsetY", type = "uiUnit", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetPortraitTexture"] = {
    ...
    params = { { name = "textureObject", type = "SimpleTexture", default = nil , examples = { { value = "self", label = "AllTheThings" }, { value = "self.Icon", label = "BagBrother" }, { value = 133139, label = "Narcissus" } } }, { name = "unitToken", type = "UnitToken", default = "player" }, { name = "disableMasking", type = "bool", default = false } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetPortraitZoom"] = {
    ...
    params = { { name = "zoom", type = "number", default = nil , examples = { { value = "data.portraitZoom and 1 or 0", label = "WeakAuras" }, { value = "0.4", label = "DBM-GUI" }, { value = "data[1]", label = "Narcissus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetPosition"] = {
    ...
    params = { { name = "positionX", type = "number", default = nil , examples = { { value = "fi * -0.1", label = "AllTheThings" }, { value = 0, label = "AllTheThings" }, { value = "fi * -0.1", label = "AllTheThings" } } }, { name = "positionY", type = "number", default = nil }, { name = "positionZ", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetRaidDifficultyID"] = {
    ...
    params = { { name = "difficultyID", type = "number", default = nil , examples = { { value = 1, label = "TitanLootType" }, { value = 2, label = "TitanLootType" }, { value = 3, label = "TitanLootType" } } }, { name = "force", type = "bool", default = false } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetRaidTarget"] = {
    ...
    params = { { name = "target", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "BigWigs_Core" }, { value = "unit", label = "BigWigs_Core" }, { value = "lastplayer[1]", label = "BigWigs_Plugins" } } }, { name = "userIndex", type = "luaIndex", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetRoll"] = {
    ...
    func = _G["SetRoll"],
    funcPath = "SetRoll",
    params = { { name = "roll", type = "number", default = nil , examples = { { value = "1.8", label = "Narcissus" }, { value = 0, label = "Narcissus" }, { value = "modelInfo[8]", label = "Narcissus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetRotation"] = {
    ...
    params = { { name = "radians", type = "number", default = nil , examples = { { value = "math.rad(-90)", label = "WeakAurasOptions" }, { value = "auraRotation / 180 * math.pi", label = "WeakAurasOptions" }, { value = "math.pi/2", label = "WeakAurasOptions" } } }, { name = "animate", type = "bool", default = true } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetScale"] = {
    ...
    func = _G["SetScale"],
    funcPath = "SetScale",
    params = { { name = "scaleX", type = "number", default = nil , examples = { { value = 1, label = "WeakAuras" }, { value = "1 / UIParent:GetEffectiveScale()", label = "WeakAuras" }, { value = "data.scale and data.scale > 0 and data.scale <= 10 and data.scale or 1", label = "WeakAuras" } } }, { name = "scaleY", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetScaleFrom"] = {
    ...
    params = { { name = "scaleX", type = "number", default = nil , examples = { { value = 0, label = "Details" }, { value = "arg1", label = "Plater" } } }, { name = "scaleY", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetScaleTo"] = {
    ...
    func = _G["SetScaleTo"],
    funcPath = "SetScaleTo",
    params = { { name = "scaleX", type = "number", default = nil , examples = { { value = 1, label = "Details" }, { value = "arg3", label = "Plater" } } }, { name = "scaleY", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetScript"] = {
    ...
    func = _G["SetScript"],
    funcPath = "SetScript",
    params = { { name = "scriptTypeName", type = "cstring", default = nil , examples = { { value = "OnUpdate", label = "WeakAuras" }, { value = "OnEvent", label = "WeakAuras" }, { value = "OnEvent", label = "WeakAuras" } } }, { name = "script", type = "luaFunction", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetSequence"] = {
    ...
    params = { { name = "sequence", type = "number", default = nil , examples = { { value = "mod.modelSequence or 4", label = "DBM-GUI" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetShadowColor"] = {
    ...
    params = { { name = "colorR", type = "number", default = nil , examples = { { value = [=[colors:GetColor("barTextShadow"]=], label = "BigWigs_LiberationOfUndermine" }, { value = "r", label = "BigWigs_LiberationOfUndermine" }, { value = [=[colors:GetColor("barTextShadow"]=], label = "BigWigs_Plugins" } } }, { name = "colorG", type = "number", default = nil }, { name = "colorB", type = "number", default = nil }, { name = "a", type = "SingleColorValue", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetShadowEffect"] = {
    ...
    params = { { name = "strength", type = "number", default = nil , examples = { { value = "0~1", label = "Narcissus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetShadowOffset"] = {
    ...
    params = { { name = "offsetX", type = "number", default = nil , examples = { { value = 1, label = "BigWigs_Plugins" }, { value = 0, label = "DBM-Core" }, { value = 1, label = "MRT" } } }, { name = "offsetY", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetShown"] = {
    ...
    func = _G["SetShown"],
    funcPath = "SetShown",
    params = { { name = "show", type = "bool", default = false , examples = { { value = [=[OptionsPrivate.Private.Features:Enabled("undo")]=], label = "WeakAurasOptions" }, { value = "pH > 0", label = "ActionHud" }, { value = "cH > 0", label = "ActionHud" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetSize"] = {
    ...
    func = _G["SetSize"],
    funcPath = "SetSize",
    params = { { name = "x", type = "uiUnit", default = nil , examples = { { value = 500, label = "WeakAuras" }, { value = 16, label = "WeakAuras" }, { value = "iconWidth - 0.2 * width", label = "WeakAuras" } } }, { name = "y", type = "uiUnit", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetSmoothProgress"] = {
    ...
    params = { { name = "durationSec", type = "number", default = nil , examples = { { value = 1, label = "WeakAuras" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=NotAllowed",
...
APIDefs["SetSmoothing"] = {
    ...
    params = { { name = "weights", type = "SmoothingType", default = nil , examples = { { value = "OUT", label = "WeakAurasOptions" }, { value = 'IN_OUT', label = "AstralKeys" }, { value = "IN_OUT", label = "Baganator" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetSpacing"] = {
    ...
    func = _G["SetSpacing"],
    funcPath = "SetSpacing",
    params = { { name = "spacing", type = "uiUnit", default = nil , examples = { { value = 3, label = "Baganator" }, { value = 4, label = "BagBrother" }, { value = 8, label = "Narcissus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetSpellVisualKit"] = {
    ...
    params = { { name = "spellVisualKitID", type = "number", default = 0 , examples = { { value = "info.spell", label = "Narcissus" }, { value = "modelInfo[9]", label = "Narcissus" }, { value = 23368, label = "Plumber" } } }, { name = "oneShot", type = "bool", default = false } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetStartColor"] = {
    ...
    params = { { name = "color", type = "colorRGBA", default = nil , examples = { { value = "CreateColor(r1", label = "Plater" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenTainted",
...
APIDefs["SetStartDelay"] = {
    ...
    params = { { name = "delaySec", type = "number", default = nil , examples = { { value = 1, label = "Bartender4" }, { value = "1.1", label = "BigWigs_Plugins" }, { value = "customDisplayTime or 1", label = "BigWigs_Plugins" } } }, { name = "recomputeGroupDuration", type = "bool", default = true } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetStartPoint"] = {
    ...
    params = { { name = "relativePoint", type = "FramePoint", default = nil , examples = { { value = "TOPLEFT", label = "WeakAurasOptions" }, { value = "TOPRIGHT", label = "WeakAurasOptions" }, { value = "TOPLEFT", label = "WeakAurasOptions" } } }, { name = "relativeTo", type = "ScriptRegion", default = nil }, { name = "offsetX", type = "uiUnit", default = 0 }, { name = "offsetY", type = "uiUnit", default = 0 } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetStepsPerPage"] = {
    ...
    params = { { name = "stepsPerPage", type = "number", default = nil , examples = { { value = 0, label = "AllTheThings" }, { value = "rowCount - 2", label = "AllTheThings" }, { value = "numToDisplay-1", label = "Plater" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetTarget"] = {
    ...
    func = _G["SetTarget"],
    funcPath = "SetTarget",
    params = { { name = "target", type = "CScriptObject", default = nil , examples = { { value = "target", label = "Bartender4" } } } },
    returns = { { name = "success", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetTextColor"] = {
    ...
    params = { { name = "colorR", type = "number", default = nil , examples = { { value = "0.5", label = "WeakAurasOptions" }, { value = 1, label = "WeakAurasOptions" }, { value = 1, label = "WeakAurasOptions" } } }, { name = "colorG", type = "number", default = nil }, { name = "colorB", type = "number", default = nil }, { name = "a", type = "SingleColorValue", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetThickness"] = {
    ...
    params = { { name = "thickness", type = "uiUnit", default = nil , examples = { { value = 2, label = "WeakAurasOptions" }, { value = 1, label = "WeakAurasOptions" }, { value = 10, label = "MRT" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetThumbTexture"] = {
    ...
    params = { { name = "asset", type = "TextureAsset", default = nil , examples = { { value = "Interface\\Buttons\\UI-ScrollBar-Knob", label = "AddonUsage" }, { value = "Interface\\Buttons\\UI-SliderBar-Button-Vertical", label = "Bartender4" }, { value = "Interface\\Buttons\\UI-SliderBar-Button-Horizontal", label = "Bartender4" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetToAlpha"] = {
    ...
    func = _G["SetToAlpha"],
    funcPath = "SetToAlpha",
    params = { { name = "normalizedAlpha", type = "number", default = nil , examples = { { value = 0, label = "AstralKeys" }, { value = 1, label = "AstralKeys" }, { value = "0.4", label = "Baganator" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=NotAllowed",
...
APIDefs["SetTransform"] = {
    ...
    params = { { name = "translation", type = "vector3", default = nil , examples = { { value = "CreateVector3D(tx", label = "WeakAuras" } } }, { name = "rotation", type = "vector3", default = nil }, { name = "scale", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetType"] = {
    ...
    func = _G["SetType"],
    funcPath = "SetType",
    params = { { name = "type", type = "LuaCurveType", default = nil , examples = { { value = "radio", label = "WeakAurasOptions" }, { value = "tooltipbar", label = "Details" }, { value = "tooltip", label = "Details" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetUnit"] = {
    ...
    func = _G["SetUnit"],
    funcPath = "SetUnit",
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "none", label = "AllTheThings" }, { value = "player", label = "AllTheThings" }, { value = "reference.unit", label = "AllTheThings" } } }, { name = "blend", type = "bool", default = true }, { name = "useNativeForm", type = "bool", default = nil } },
    returns = { { name = "success", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetUnitCursorTexture"] = {
    ...
    params = { { name = "textureObject", type = "SimpleTexture", default = nil , examples = { { value = "Display.InteractIcon", label = "Plumber" } } }, { name = "unit", type = "UnitToken", default = "player" }, { name = "style", type = "CursorStyle", default = nil }, { name = "includeLowPriority", type = "bool", default = nil } },
...
APIDefs["SetValue"] = {
    ...
    func = _G["SetValue"],
    funcPath = "SetValue",
    params = { { name = "value", type = "number", default = nil , examples = { { value = "1 - self.bar:GetValue()", label = "WeakAuras" }, { value = 0, label = "WeakAuras" }, { value = 0, label = "WeakAurasOptions" } } }, { name = "treatAsMouseEvent", type = "bool", default = false } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetValueStep"] = {
    ...
    params = { { name = "valueStep", type = "number", default = nil , examples = { { value = 1, label = "WeakAurasOptions" }, { value = 10, label = "AllTheThings" }, { value = "0.1", label = "AllTheThings" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetViewInsets"] = {
    ...
    params = { { name = "left", type = "uiUnit", default = nil , examples = { { value = 0, label = "Narcissus" }, { value = 4, label = "Narcissus" }, { value = 0, label = "Narcissus_Achievements" } } }, { name = "right", type = "uiUnit", default = nil }, { name = "top", type = "uiUnit", default = nil }, { name = "bottom", type = "uiUnit", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetViewTranslation"] = {
    ...
    params = { { name = "x", type = "uiUnit", default = nil , examples = { { value = 0, label = "Narcissus" }, { value = 0, label = "Narcissus" }, { value = 6, label = "Narcissus" } } }, { name = "y", type = "uiUnit", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetWidth"] = {
    ...
    func = _G["SetWidth"],
    funcPath = "SetWidth",
    params = { { name = "width", type = "uiUnit", default = nil , examples = { { value = 1, label = "WeakAuras" }, { value = 32, label = "WeakAuras" }, { value = "show and (xProgress + 0.1) or 0.1", label = "WeakAuras" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetYaw"] = {
    ...
    func = _G["SetYaw"],
    funcPath = "SetYaw",
    params = { { name = "yaw", type = "number", default = nil , examples = { { value = "-3.14/3", label = "Narcissus" }, { value = "-math.pi*0.5", label = "Narcissus" }, { value = "-1.57", label = "Narcissus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["SetZoom"] = {
    ...
    func = _G["SetZoom"],
    funcPath = "SetZoom",
    params = { { name = "zoom", type = "number", default = nil , examples = { { value = "zoom < 2 and zoom + 1 or zoom - 1", label = "TomTom" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["StartPlayerPing"] = {
    ...
    params = { { name = "duration", type = "number", default = 0 , examples = { { value = 2, label = "Plumber" }, { value = "2.75", label = "Plumber" } } }, { name = "fadeDuration", type = "number", default = 0 } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["TransformCameraSpaceToModelSpace"] = {
    ...
    params = { { name = "cameraPosition", type = "vector3", default = nil , examples = { { value = "SharedVector3D", label = "Narcissus" }, { value = 0, label = "Narcissus" } } } },
...
APIDefs["TryOn"] = {
    ...
    func = _G["TryOn"],
    funcPath = "TryOn",
    params = { { name = "itemLinkOrItemModifiedAppearanceID", type = "cstring", default = nil , examples = { { value = "item:72019", label = "Narcissus" }, { value = "item:72020", label = "Narcissus" }, { value = [=["item:"..self.itemID]=], label = "Narcissus" } } }, { name = "handSlotName", type = "cstring", default = nil }, { name = "spellEnchantmentID", type = "number", default = 0 } },
...
APIDefs["Undress"] = {
    ...
    func = _G["Undress"],
    funcPath = "Undress",
    params = { { name = "includeWeapons", type = "bool", default = true , examples = { { value = 16, label = "Narcissus_Database_Item" }, { value = 17, label = "Narcissus_Database_Item" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UndressSlot"] = {
    ...
    params = { { name = "inventorySlots", type = "number", default = nil , examples = { { value = 16, label = "Narcissus" }, { value = 17, label = "Narcissus" }, { value = 1, label = "Narcissus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitAffectingCombat"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "player", label = "WeakAuras" }, { value = "unit", label = "WeakAuras" }, { value = 'player', label = "WeakAuras" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitArmor"] = {
    ...
    func = _G["UnitArmor"],
    funcPath = "UnitArmor",
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = 'player', label = "WeakAuras" }, { value = "unit", label = "Details" } } } },
...
APIDefs["UnitAttackPower"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "player", label = "WeakAuras" }, { value = "unit", label = "DejaCharacterStats" } } } },
...
APIDefs["UnitCanAssist"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "Details" }, { value = "player", label = "Plater" } } }, { name = "target", type = "UnitToken", default = "player" } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitCanAttack"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "player", label = "WeakAuras" }, { value = "player", label = "WeakAuras" }, { value = 'player', label = "WeakAuras" } } }, { name = "target", type = "UnitToken", default = "player" } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitCanCooperate"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "Details" }, { value = "target", label = "Leatrix_Plus" } } }, { name = "target", type = "UnitToken", default = "player" } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitCastingInfo"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "player", label = "BigWigs" }, { value = "unit", label = "BigWigs_NerubarPalace" }, { value = "boss1", label = "DBM-Party-Legion" } } } },
...
APIDefs["UnitChannelInfo"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" }, { value = "boss1", label = "DBM-Raids-WarWithin" }, { value = "player", label = "Details_Streamer" } } } },
...
APIDefs["UnitClass"] = {
    ...
    func = _G["UnitClass"],
    funcPath = "UnitClass",
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" }, { value = "player", label = "WeakAuras" }, { value = 'player', label = "WeakAuras" } } } },
...
APIDefs["UnitClassBase"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = 'player', label = "BagBrother" }, { value = "player", label = "Bartender4" }, { value = [=[LT["Unit"]]=], label = "Leatrix_Plus" } } } },
...
APIDefs["UnitClassification"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" }, { value = [=[LT["Unit"]]=], label = "Leatrix_Plus" }, { value = "target", label = "Leatrix_Plus" } } } },
    returns = { { name = "result", type = "cstring", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitControllingVehicle"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "player", label = "Dominos" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitCreatureFamily"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" }, { value = [=[arg.."pet"]=], label = "MRT" } } } },
...
APIDefs["UnitCreatureType"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" }, { value = [=[LT["Unit"]]=], label = "Leatrix_Plus" } } } },
    returns = { { name = "name", type = "cstring", canBeSecret = false }, { name = "id", type = "number", canBeSecret = false } },
    midnightImpact = "CONDITIONAL",
    midnightNote = "Secret behavior: SecretWhenUnitIdentityRestricted, SecretArguments=AllowedWhenUntainted",
}
...
APIDefs["UnitDetailedThreatSituation"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = [=[sourceUnit or "player"]=], label = "BigWigs_Core" }, { value = "uId", label = "DBM-Core" }, { value = "id", label = "DBM-Core" } } }, { name = "mobGUID", type = "UnitToken", default = "player" } },
...
APIDefs["UnitEffectiveLevel"] = {
    ...
    params = { { name = "name", type = "cstring", default = nil , examples = { { value = 'player', label = "WeakAuras" }, { value = "player", label = "WeakAuras" }, { value = "unit", label = "DejaCharacterStats" } } } },
    returns = { { name = "result", type = "number", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitExists"] = {
    ...
    func = _G["UnitExists"],
    funcPath = "UnitExists",
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" }, { value = "arg1", label = "WeakAuras" }, { value = "target", label = "WeakAuras" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitFactionGroup"] = {
    ...
    params = { { name = "unitName", type = "cstring", default = nil , examples = { { value = "player", label = "WeakAuras" }, { value = "npc", label = "AllTheThings" }, { value = 'player', label = "AstralKeys" } } }, { name = "checkDisplayRace", type = "bool", default = false } },
...
APIDefs["UnitFullName"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "player", label = "WeakAuras" }, { value = "unit", label = "WeakAuras" }, { value = 'player', label = "BagBrother" } } } },
...
APIDefs["UnitGUID"] = {
    ...
    func = _G["UnitGUID"],
    funcPath = "UnitGUID",
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "player", label = "WeakAuras" }, { value = "unit", label = "WeakAuras" }, { value = "pet", label = "WeakAuras" } } } },
...
APIDefs["UnitGetDetailedHealPrediction"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "DandersFrames" }, { value = "unit", label = "DandersFrames" } } }, { name = "healerUnit", type = "UnitToken", default = "player" }, { name = "healPredictionCalculator", type = "UnitHealPredictionCalculator", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitGetIncomingHeals"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" }, { value = "unit", label = "DandersFrames" } } }, { name = "healerGUID", type = "UnitToken", default = "player" } },
...
APIDefs["UnitGetTotalAbsorbs"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" }, { value = "u", label = "ActionHud" }, { value = "boss1", label = "DBM-Party-MoP" } } } },
    returns = { { name = "result", type = "number", canBeSecret = true } },
    midnightImpact = "HIGH",
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted, SecretReturns",
}
...
APIDefs["UnitGetTotalHealAbsorbs"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" } } } },
    returns = { { name = "result", type = "number", canBeSecret = true } },
    midnightImpact = "HIGH",
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted, SecretReturns",
}
...
APIDefs["UnitGroupRolesAssigned"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" }, { value = "player", label = "WeakAuras" }, { value = "frame.unit", label = "DandersFrames" } } } },
    returns = { { name = "result", type = "cstring", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitHPPerStamina"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "player", label = "Narcissus" } } } },
    returns = { { name = "result", type = "number", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitHasRelicSlot"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "Details" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitHasVehicleUI"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = 'player', label = "WeakAuras" }, { value = "player", label = "Bartender4" }, { value = "self.unit", label = "Plater" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitHealth"] = {
    ...
    func = _G["UnitHealth"],
    funcPath = "UnitHealth",
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" }, { value = "unit", label = "ActionHud" }, { value = "boss1", label = "BigWigs_Core" } } }, { name = "usePredicted", type = "bool", default = true } },
    returns = { { name = "result", type = "number", canBeSecret = true } },
    midnightImpact = "HIGH",
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted, SecretReturns",
}
...
APIDefs["UnitHealthMax"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" }, { value = "unit", label = "ActionHud" }, { value = "player", label = "DBM-Core" } } } },
    returns = { { name = "result", type = "number", canBeSecret = false } },
    midnightImpact = "CONDITIONAL",
...
APIDefs["UnitHealthMissing"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "DandersFrames" }, { value = "unitFrame.unit", label = "Plater" } } }, { name = "usePredicted", type = "bool", default = true } },
    returns = { { name = "result", type = "number", canBeSecret = true } },
    midnightImpact = "HIGH",
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted, SecretReturns",
}
...
APIDefs["UnitHealthPercent"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "ActionHud" }, { value = "unit", label = "DandersFrames" }, { value = "unit", label = "DandersFrames" } } }, { name = "usePredicted", type = "bool", default = true }, { name = "curve", type = "LuaCurveObjectBase", default = nil } },
...
APIDefs["UnitHonor"] = {
    ...
    func = _G["UnitHonor"],
    funcPath = "UnitHonor",
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "player", label = "DejaCharacterStats" }, { value = 'player', label = "Dominos_Progress" } } } },
    returns = { { name = "result", type = "number", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitHonorLevel"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "player", label = "DejaCharacterStats" } } } },
    returns = { { name = "result", type = "number", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitInBattleground"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "player", label = "WeakAuras" }, { value = "unit", label = "Details" } } }, { name = "partyIndex", type = "luaIndex", default = nil } },
...
APIDefs["UnitInParty"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "player", label = "WeakAuras" }, { value = "player", label = "AllTheThings" }, { value = "unit", label = "Details" } } }, { name = "partyIndex", type = "luaIndex", default = nil } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitInPartyIsAI"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "BigWigs_Core" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitInRaid"] = {
    ...
    func = _G["UnitInRaid"],
    funcPath = "UnitInRaid",
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" }, { value = "player", label = "WeakAuras" }, { value = "player", label = "AllTheThings" } } }, { name = "partyIndex", type = "luaIndex", default = nil } },
    returns = { { name = "result", type = "luaIndex", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitInSubgroup"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" }, { value = "WeakAuras.petUnitToUnit[unit] or unit", label = "WeakAuras" }, { value = "WeakAuras.petUnitToUnit[unit]", label = "WeakAuras" } } }, { name = "partyIndex", type = "luaIndex", default = nil } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitInVehicle"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = 'player', label = "WeakAuras" }, { value = "player", label = "DBM-Challenges" }, { value = "unit", label = "DejaCharacterStats" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitIsAFK"] = {
    ...
    func = _G["UnitIsAFK"],
    funcPath = "UnitIsAFK",
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" }, { value = 'player', label = "WeakAuras" }, { value = "player", label = "DBM-Core" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitIsBossMob"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "target", label = "Plumber" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitIsCharmed"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "Details" }, { value = [=[LT["Unit"]]=], label = "Leatrix_Plus" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitIsConnected"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" }, { value = "player", label = "BigWigs" }, { value = "id", label = "DBM-Core" } } } },
...
APIDefs["UnitIsCorpse"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "mouseover", label = "BigWigs_Core" }, { value = "unit", label = "Details" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitIsDead"] = {
    ...
    func = _G["UnitIsDead"],
    funcPath = "UnitIsDead",
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = 'pet', label = "WeakAuras" }, { value = "player", label = "Baganator" }, { value = 'player', label = "BagBrother" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitIsDeadOrGhost"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" }, { value = 'player', label = "WeakAuras" }, { value = "player", label = "BigWigs_Core" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitIsEnemy"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "player", label = "ActionHud" }, { value = "player", label = "DBM-Party-BfA" }, { value = "unit", label = "Details" } } }, { name = "target", type = "UnitToken", default = "player" } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitIsFriend"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "player", label = "ActionHud" }, { value = "player", label = "DBM-Core" }, { value = "player", label = "DBM-Core" } } }, { name = "target", type = "UnitToken", default = "player" } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitIsGameObject"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "Plumber" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitIsGhost"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "DandersFrames" }, { value = "v.id", label = "DBM-Core" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitIsGroupAssistant"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "player", label = "WeakAuras" }, { value = "unit", label = "DandersFrames" } } } },
...
APIDefs["UnitIsGroupLeader"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "player", label = "WeakAuras" }, { value = "t.unit", label = "AllTheThings" }, { value = "player", label = "AllTheThings" } } }, { name = "partyCategory", type = "luaIndex", default = nil } },
...
APIDefs["UnitIsInMyGuild"] = {
    ...
    params = { { name = "unit", type = "cstring", default = nil , examples = { { value = "unit", label = "Details" }, { value = [=[LT["Unit"]]=], label = "Leatrix_Plus" }, { value = "id", label = "TitanLootType" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitIsOtherPlayersPet"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "Narcissus_Database_NPC" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitIsPVP"] = {
    ...
    func = _G["UnitIsPVP"],
    funcPath = "UnitIsPVP",
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = 'player', label = "WeakAuras" }, { value = "player", label = "WeakAuras" }, { value = "unit", label = "Details" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitIsPlayer"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" }, { value = "target", label = "AllTheThings" }, { value = [=[uId .. "target"]=], label = "DBM-Core" } } }, { name = "partyIndex", type = "luaIndex", default = nil } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitIsSameServer"] = {
    ...
    params = { { name = "unitName", type = "cstring", default = nil , examples = { { value = "unit", label = "Details" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitIsTapDenied"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = [=[LT["Unit"]]=], label = "Leatrix_Plus" }, { value = "unit", label = "Plater" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitIsUnit"] = {
    ...
    func = _G["UnitIsUnit"],
    funcPath = "UnitIsUnit",
    params = { { name = "unit1", type = "UnitToken", default = "player" , examples = { { value = "player", label = "WeakAuras" }, { value = "pet", label = "WeakAuras" }, { value = "player", label = "WeakAuras" } } }, { name = "unit2", type = "UnitToken", default = "player" } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "CONDITIONAL",
...
APIDefs["UnitIsVisible"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" }, { value = "unitFrame.unit", label = "Plater" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitIsWildBattlePet"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = [=[LT["Unit"]]=], label = "Leatrix_Plus" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitLevel"] = {
    ...
    func = _G["UnitLevel"],
    funcPath = "UnitLevel",
    params = { { name = "name", type = "cstring", default = nil , examples = { { value = "unit", label = "WeakAuras" }, { value = "player", label = "WeakAuras" }, { value = 'player', label = "WeakAuras" } } } },
    returns = { { name = "result", type = "number", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitName"] = {
    ...
    func = _G["UnitName"],
    funcPath = "UnitName",
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" }, { value = "unit", label = "WeakAuras" }, { value = "player", label = "WeakAuras" } } } },
    returns = { { name = "unitName", type = "cstring", canBeSecret = false }, { name = "unitServer", type = "cstring", canBeSecret = false } },
    midnightImpact = "CONDITIONAL",
...
APIDefs["UnitNameUnmodified"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "player", label = "!BugGrabber" }, { value = "unit", label = "TalentTreeTweaks" } } } },
    returns = { { name = "unitName", type = "cstring", canBeSecret = false }, { name = "unitServer", type = "cstring", canBeSecret = false } },
    midnightImpact = "CONDITIONAL",
    midnightNote = "Secret behavior: SecretWhenUnitIdentityRestricted, SecretArguments=AllowedWhenUntainted",
}
...
APIDefs["UnitOnTaxi"] = {
    ...
    func = _G["UnitOnTaxi"],
    funcPath = "UnitOnTaxi",
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = 'player', label = "WeakAuras" }, { value = "player", label = "Bartender4" }, { value = "unit", label = "Details" } } } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitPartialPower"] = {
    ...
    params = { { name = "unitToken", type = "UnitToken", default = "player" , examples = { { value = "player", label = "WeakAuras" }, { value = "unit", label = "ActionHud" }, { value = "player", label = "Plater" } } }, { name = "powerType", type = "PowerType", default = nil }, { name = "unmodified", type = "bool", default = false } },
...
APIDefs["UnitPhaseReason"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "BigWigs_Plugins" } } } },
...
APIDefs["UnitPlayerOrPetInParty"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "DBM-Core" } } }, { name = "partyIndex", type = "luaIndex", default = nil } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitPosition"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "player", label = "BigWigs_Core" }, { value = "player", label = "BigWigs_Plugins" }, { value = "unit", label = "BigWigs_Plugins" } } } },
...
APIDefs["UnitPower"] = {
    ...
    func = _G["UnitPower"],
    funcPath = "UnitPower",
    params = { { name = "unitToken", type = "UnitToken", default = "player" , examples = { { value = "player", label = "WeakAuras" }, { value = "player", label = "WeakAuras" }, { value = "unit", label = "WeakAuras" } } }, { name = "powerType", type = "PowerType", default = nil }, { name = "unmodified", type = "bool", default = false } },
...
APIDefs["UnitPowerBarID"] = {
    ...
    params = { { name = "unitToken", type = "UnitToken", default = "player" , examples = { { value = "player", label = "WeakAuras" } } } },
...
APIDefs["UnitPowerType"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "WeakAuras" }, { value = "player", label = "ActionHud" }, { value = "unit", label = "Details" } } }, { name = "index", type = "number", default = 0 } },
...
APIDefs["UnitRace"] = {
    ...
    func = _G["UnitRace"],
    funcPath = "UnitRace",
    params = { { name = "name", type = "cstring", default = nil , examples = { { value = "player", label = "WeakAuras" }, { value = 'player', label = "WeakAurasTemplates" }, { value = "unit", label = "AllTheThings" } } } },
...
APIDefs["UnitReaction"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "player", label = "WeakAuras" }, { value = "unit", label = "Details" }, { value = "target", label = "Details" } } }, { name = "target", type = "UnitToken", default = "player" } },
    returns = { { name = "result", type = "luaIndex", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitRealmRelationship"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "v.id", label = "DBM-Core" } } } },
...
APIDefs["UnitSelectionColor"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "Details" } } }, { name = "useExtendedColors", type = "bool", default = false } },
...
APIDefs["UnitSetRole"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "player", label = "BigWigs" } } }, { name = "roleStr", type = "cstring", default = nil } },
    returns = { { name = "result", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitSex"] = {
    ...
    func = _G["UnitSex"],
    funcPath = "UnitSex",
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "player", label = "WeakAuras" }, { value = 'player', label = "BagBrother" }, { value = "unit", label = "BigWigs_Core" } } } },
...
APIDefs["UnitSpellTargetClass"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "self.unit", label = "Plater" } } } },
...
APIDefs["UnitStagger"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = "player", label = "WeakAuras" }, { value = "unit", label = "WeakAuras" } } } },
    returns = { { name = "result", type = "number", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitStat"] = {
    ...
    func = _G["UnitStat"],
    funcPath = "UnitStat",
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = 'player', label = "WeakAuras" }, { value = 'player', label = "WeakAuras" }, { value = 'player', label = "WeakAuras" } } }, { name = "index", type = "luaIndex", default = nil } },
...
APIDefs["UnitThreatSituation"] = {
    ...
    params = { { name = "unit", type = "UnitToken", default = "player" , examples = { { value = 'player', label = "WeakAuras" }, { value = "unit", label = "DandersFrames" }, { value = "unit", label = "Details" } } }, { name = "mobGUID", type = "UnitToken", default = "player" } },
    returns = { { name = "result", type = "number", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["UnitTokenFromGUID"] = {
    ...
    params = { { name = "unitGUID", type = "WOWGUID", default = nil , examples = { { value = "guid", label = "BigWigs_Core" }, { value = "id", label = "BigWigs_Core" } } } },
...
APIDefs["canaccessvalue"] = {
    ...
    params = { { name = "value", type = "LuaValueReference", default = nil , examples = { { value = "aura.spellId", label = "Leatrix_Plus" }, { value = "UnitName'target'", label = "MRT" }, { value = [=[UnitName("target")]=], label = "MRT" } } } },
...
APIDefs["issecretvalue"] = {
    ...
    params = { { name = "value", type = "LuaValueReference", default = nil , examples = { { value = "guid", label = "BigWigs_Core" }, { value = "arg1", label = "Plater" }, { value = "arg2", label = "Plater" } } } },
