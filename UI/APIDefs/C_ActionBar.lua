...
APIDefs["C_ActionBar.GetActionDisplayCount"] = {
    ...
    params = { { name = "actionID", type = "luaIndex", default = nil , examples = { { value = "self._state_action", label = "Bartender4" } } }, { name = "maxDisplayCount", type = "number", default = 9999 }, { name = "replacementString", type = "cstring", default = "*" } },
...
APIDefs["C_ActionBar.GetSpell"] = {
    ...
    params = { { name = "actionID", type = "luaIndex", default = nil , examples = { { value = 395296, label = "Details" }, { value = 403264, label = "Details" }, { value = 372571, label = "Details" } } } },
...
APIDefs["C_ActionBar.HasAction"] = {
    ...
    params = { { name = "actionID", type = "luaIndex", default = nil , examples = { { value = [=[self:GetAttribute("action")]=], label = "Dominos" } } } },
...
APIDefs["C_ActionBar.IsActionInRange"] = {
    ...
    params = { { name = "actionID", type = "luaIndex", default = nil , examples = { { value = "self._state_action", label = "Bartender4" } } }, { name = "target", type = "UnitToken", default = "player" } },
