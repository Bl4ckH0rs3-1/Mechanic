...
APIDefs["C_TransmogOutfitInfo.ChangeDisplayedOutfit"] = {
    ...
    params = { { name = "outfitID", type = "number", default = nil , examples = { { value = 2, label = "Plumber" } } }, { name = "trigger", type = "TransmogSituationTrigger", default = nil }, { name = "toggleLock", type = "bool", default = nil }, { name = "allowRemoveOutfit", type = "bool", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_TransmogOutfitInfo.GetOutfitInfo"] = {
    ...
    params = { { name = "outfitID", type = "number", default = nil , examples = { { value = "ID", label = "Plumber" } } } },
...
APIDefs["C_TransmogOutfitInfo.GetTransmogOutfitSlotFromInventorySlot"] = {
    ...
    params = { { name = "inventorySlot", type = "InventorySlots", default = nil , examples = { { value = "slotID - 1", label = "Narcissus" } } } },
    returns = { { name = "slot", type = "TransmogOutfitSlot", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
