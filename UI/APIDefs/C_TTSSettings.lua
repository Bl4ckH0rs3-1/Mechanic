...
APIDefs["C_TTSSettings.GetSetting"] = {
    ...
    params = { { name = "setting", type = "TtsBoolSetting", default = nil , examples = { { value = 'util.askprice.activated', label = "AllTheThings" } } } },
    returns = { { name = "enabled", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_TTSSettings.SetSetting"] = {
    ...
    params = { { name = "setting", type = "TtsBoolSetting", default = nil , examples = { { value = "util.askprice.activated", label = "AllTheThings" }, { value = "util.askprice.activated", label = "AllTheThings" }, { value = "height", label = "Details" } } }, { name = "newVal", type = "bool", default = false } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
