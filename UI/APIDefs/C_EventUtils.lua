...
APIDefs["C_EventUtils.IsEventValid"] = {
    ...
    params = { { name = "eventName", type = "stringView", default = nil , examples = { { value = "PET_JOURNAL_PET_DELETED", label = "Baganator" }, { value = "SOCKET_INFO_UPDATE", label = "Baganator" }, { value = "SPELL_TEXT_UPDATE", label = "Details" } } } },
