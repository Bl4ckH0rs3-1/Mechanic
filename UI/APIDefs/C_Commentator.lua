...
APIDefs["C_Commentator.FollowUnit"] = {
    ...
    params = { { name = "token", type = "string", default = nil , examples = { { value = "unit", label = "Details" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Commentator.GetInstanceInfo"] = {
    ...
    params = { { name = "mapIndex", type = "luaIndex", default = nil , examples = { { value = "id", label = "Details" } } }, { name = "instanceIndex", type = "luaIndex", default = nil } },
...
APIDefs["C_Commentator.GetMapInfo"] = {
    ...
    params = { { name = "mapIndex", type = "luaIndex", default = nil , examples = { { value = "-id", label = "BigWigs" }, { value = "tonumber(firstMapId:sub(2)) or 0", label = "DBM-Core" }, { value = "tonumber(name:sub(2)) or 0", label = "DBM-Core" } } } },
...
APIDefs["C_Commentator.SetCamera"] = {
    ...
    params = { { name = "xPos", type = "number", default = nil , examples = { { value = 0, label = "Narcissus" } } }, { name = "yPos", type = "number", default = nil }, { name = "zPos", type = "number", default = nil }, { name = "yaw", type = "number", default = nil }, { name = "pitch", type = "number", default = nil }, { name = "roll", type = "number", default = nil }, { name = "fov", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Commentator.SetCameraPosition"] = {
    ...
    params = { { name = "xPos", type = "number", default = nil , examples = { { value = "3.84", label = "Narcissus" }, { value = "NarciNPCModelFrame2:GetCameraPosition()", label = "Narcissus" }, { value = 10, label = "Narcissus" } } }, { name = "yPos", type = "number", default = nil }, { name = "zPos", type = "number", default = nil }, { name = "snapToLocation", type = "bool", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
