...
APIDefs["C_AzeriteEssence.GetEssenceHyperlink"] = {
    ...
    params = { { name = "essenceID", type = "number", default = nil , examples = { { value = "i", label = "MRT" } } }, { name = "rank", type = "number", default = nil } },
...
APIDefs["C_AzeriteEssence.GetMilestoneEssence"] = {
    ...
    params = { { name = "milestoneID", type = "number", default = nil , examples = { { value = "milestone.ID", label = "MRT" }, { value = 115, label = "Narcissus" } } } },
