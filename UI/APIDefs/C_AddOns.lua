...
APIDefs["C_AddOns.DisableAddOn"] = {
    ...
    params = { { name = "name", type = "uiAddon", default = nil , examples = { { value = "ZygorGuidesViewer", label = "Leatrix_Plus" }, { value = "!Swatter", label = "!BugGrabber" }, { value = "name", label = "ACP" } } }, { name = "character", type = "cstring", default = "0" } },
    returns = {  },
...
APIDefs["C_AddOns.DisableAllAddOns"] = {
    ...
    params = { { name = "character", type = "cstring", default = nil , examples = { { value = [=[UnitGUID("player")]=], label = "ACP" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_AddOns.DoesAddOnExist"] = {
    ...
    params = { { name = "name", type = "uiAddon", default = nil , examples = { { value = "Syndicator", label = "Baganator" }, { value = "DBM-Raids-Vanilla", label = "DBM-Core" }, { value = "DBM-Raids-BC", label = "DBM-Core" } } } },
...
APIDefs["C_AddOns.EnableAddOn"] = {
    ...
    params = { { name = "name", type = "uiAddon", default = nil , examples = { { value = "WeakAurasCompanion", label = "WeakAuras" }, { value = "WeakAurasArchive", label = "WeakAuras" }, { value = "Syndicator", label = "Baganator" } } }, { name = "character", type = "cstring", default = "0" } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_AddOns.GetAddOnEnableState"] = {
    ...
    params = { { name = "name", type = "uiAddon", default = nil , examples = { { value = "WeakAurasTemplates", label = "WeakAurasOptions" }, { value = "VEM-Core", label = "DBM-Core" }, { value = "DBM-Profiles", label = "DBM-Core" } } }, { name = "character", type = "cstring", default = "0" } },
...
APIDefs["C_AddOns.GetAddOnInfo"] = {
    ...
    params = { { name = "name", type = "uiAddon", default = nil , examples = { { value = "GatherMate2_Data", label = "GatherMate2" }, { value = "ZygorGuidesViewer", label = "Leatrix_Plus" }, { value = "SexyMap", label = "RaidAchievement" } } } },
...
APIDefs["C_AddOns.GetAddOnMetadata"] = {
    ...
    params = { { name = "name", type = "uiAddon", default = nil , examples = { { value = "WeakAuras", label = "WeakAuras" }, { value = "WeakAuras", label = "WeakAuras" }, { value = "ActionHud", label = "ActionHud" } } }, { name = "variable", type = "cstring", default = nil } },
...
APIDefs["C_AddOns.IsAddOnLoaded"] = {
    ...
    params = { { name = "name", type = "uiAddon", default = nil , examples = { { value = "CustomNames", label = "WeakAuras" }, { value = "WeakAurasOptions", label = "WeakAuras" }, { value = "WeakAurasArchive", label = "WeakAuras" } } } },
...
APIDefs["C_AddOns.LoadAddOn"] = {
    ...
    params = { { name = "name", type = "uiAddon", default = nil , examples = { { value = "WeakAurasOptions", label = "WeakAuras" }, { value = "WeakAurasArchive", label = "WeakAuras" }, { value = "WeakAurasModelPaths", label = "WeakAurasOptions" } } } },
