...
APIDefs["C_ColorUtil.WrapTextInColorCode"] = {
    ...
    params = { { name = "text", type = "cstring", default = nil , examples = { { value = "Ambiguate(k", label = "AstralKeys" }, { value = "Ambiguate(unit", label = "AstralKeys" }, { value = "unit", label = "AstralKeys" } } }, { name = "textColorCode", type = "cstring", default = nil } },
    returns = { { name = "coloredText", type = "string", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenTainted",
