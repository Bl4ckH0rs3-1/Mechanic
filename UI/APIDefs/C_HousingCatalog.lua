...
APIDefs["C_HousingCatalog.GetCatalogEntryInfoByRecordID"] = {
    ...
    params = { { name = "entryType", type = "HousingCatalogEntryType", default = nil , examples = { { value = 1, label = "Plumber" }, { value = 1, label = "Plumber" }, { value = 1, label = "Plumber" } } }, { name = "recordID", type = "number", default = nil }, { name = "tryGetOwnedInfo", type = "bool", default = nil } },
    returns = { { name = "info", type = "HousingCatalogEntryInfo", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
