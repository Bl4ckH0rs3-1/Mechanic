...
APIDefs["C_GossipInfo.GetFriendshipReputation"] = {
    ...
    params = { { name = "friendshipFactionID", type = "number", default = nil , examples = { { value = "maxReputation[1]", label = "AllTheThings" } } } },
...
APIDefs["C_GossipInfo.SelectOption"] = {
    ...
    params = { { name = "optionID", type = "number", default = nil , examples = { { value = "realGossipOptionID", label = "DBM-Core" }, { value = "gossipOptionID", label = "DBM-Core" }, { value = "gossipInfoTable[1].gossipOptionID", label = "Leatrix_Plus" } } }, { name = "text", type = "cstring", default = nil }, { name = "confirmed", type = "bool", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_GossipInfo.SelectOptionByIndex"] = {
    ...
    params = { { name = "optionID", type = "number", default = nil , examples = { { value = "gossipOptionID", label = "DBM-Core" } } }, { name = "text", type = "cstring", default = nil }, { name = "confirmed", type = "bool", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
