...
APIDefs["C_ContributionCollector.Contribute"] = {
    ...
    params = { { name = "contributionID", type = "number", default = nil , examples = { { value = "not app.Contributor and 1", label = "AllTheThings" } } } },
    returns = {  },
...
APIDefs["C_ContributionCollector.GetName"] = {
    ...
    params = { { name = "contributionID", type = "number", default = nil , examples = { { value = "id", label = "Narcissus" } } } },
