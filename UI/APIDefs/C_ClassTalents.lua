...
APIDefs["C_ClassTalents.ImportLoadout"] = {
    ...
    params = { { name = "configID", type = "number", default = nil , examples = { { value = "configID", label = "Leatrix_Plus" } } }, { name = "entries", type = "table", default = nil }, { name = "name", type = "string", default = nil }, { name = "importString", type = "string", default = nil } },
...
APIDefs["C_ClassTalents.InitializeViewLoadout"] = {
    ...
    params = { { name = "specID", type = "number", default = nil , examples = { { value = "specId", label = "WeakAuras" } } }, { name = "level", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
