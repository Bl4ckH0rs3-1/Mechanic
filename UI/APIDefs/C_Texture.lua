...
APIDefs["C_Texture.GetAtlasInfo"] = {
    ...
    params = { { name = "atlas", type = "textureAtlas", default = nil , examples = { { value = "AnimCreate_Icon_Folder", label = "Baganator" }, { value = "D4:GetRaceAtlas(race", label = "MoveAny" }, { value = "ShipMissionIcon-Bonus-MapBadge", label = "MRT" } } } },
