...
APIDefs["C_Traits.GenerateInspectImportString"] = {
    ...
    params = { { name = "target", type = "cstring", default = nil , examples = { { value = "unit", label = "TalentTreeTweaks" } } } },
    returns = { { name = "importString", type = "string", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Traits.GetConfigIDBySystemID"] = {
    ...
    params = { { name = "systemID", type = "number", default = nil , examples = { { value = 1, label = "Leatrix_Plus" } } } },
...
APIDefs["C_Traits.GetConfigIDByTreeID"] = {
    ...
    params = { { name = "treeID", type = "number", default = nil , examples = { { value = 1161, label = "Narcissus" } } } },
    returns = { { name = "configID", type = "number", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Traits.GetNodeInfo"] = {
    ...
    params = { { name = "configID", type = "number", default = nil , examples = { { value = "configID", label = "Narcissus" }, { value = "C_ClassTalents.GetActiveConfigID() or Constants.TraitConsts.VIEW_TRAIT_CONFIG_ID or -3", label = "TalentTreeTweaks" }, { value = "C_ClassTalents.GetActiveConfigID()", label = "TalentTreeTweaks" } } }, { name = "nodeID", type = "number", default = nil } },
...
APIDefs["C_Traits.GetTreeHash"] = {
    ...
    params = { { name = "treeID", type = "number", default = nil , examples = { { value = "treeInfo.ID", label = "Narcissus" } } } },
...
APIDefs["C_Traits.GetTreeInfo"] = {
    ...
    params = { { name = "configID", type = "number", default = nil , examples = { { value = "configId", label = "Plater" } } }, { name = "treeID", type = "number", default = nil } },
...
APIDefs["C_Traits.GetTreeNodes"] = {
    ...
    params = { { name = "treeID", type = "number", default = nil , examples = { { value = 672, label = "Leatrix_Plus" } } } },
...
APIDefs["C_Traits.SetSelection"] = {
    ...
    params = { { name = "configID", type = "number", default = nil , examples = { { value = "c", label = "Leatrix_Plus" }, { value = "self.configID", label = "TalentTreeTweaks" }, { value = "i == ID", label = "Narcissus" } } }, { name = "nodeID", type = "number", default = nil }, { name = "nodeEntryID", type = "number", default = nil }, { name = "clearEdges", type = "bool", default = nil } },
    returns = { { name = "success", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
