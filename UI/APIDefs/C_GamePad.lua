...
APIDefs["C_GamePad.GetPowerLevel"] = {
    ...
    params = { { name = "deviceID", type = "number", default = nil , examples = { { value = "item", label = "Dominos_Progress" } } } },
...
APIDefs["C_GamePad.SetVibration"] = {
    ...
    params = { { name = "vibrationType", type = "cstring", default = nil , examples = { { value = "High", label = "DBM-Core" } } }, { name = "intensity", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
