...
APIDefs["C_BattleNet.GetAccountInfoByGUID"] = {
    ...
    params = { { name = "guid", type = "WOWGUID", default = nil , examples = { { value = "guid", label = "AllTheThings" } } } },
...
APIDefs["C_BattleNet.GetFriendGameAccountInfo"] = {
    ...
    params = { { name = "friendIndex", type = "luaIndex", default = nil , examples = { { value = "self.id", label = "AstralKeys" } } }, { name = "accountIndex", type = "luaIndex", default = nil } },
...
APIDefs["C_BattleNet.GetFriendNumGameAccounts"] = {
    ...
    params = { { name = "friendIndex", type = "luaIndex", default = nil , examples = { { value = "self.id", label = "AstralKeys" } } } },
...
APIDefs["C_BattleNet.GetGameAccountInfoByGUID"] = {
    ...
    params = { { name = "guid", type = "WOWGUID", default = nil , examples = { { value = "guid", label = "AllTheThings" }, { value = [=[UnitGUID("player")]=], label = "TomTom" } } } },
    returns = { { name = "gameAccountInfo", type = "BNetGameAccountInfo", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
