...
APIDefs["C_CurrencyInfo.ExpandCurrencyList"] = {
    ...
    params = { { name = "index", type = "luaIndex", default = nil , examples = { { value = "index", label = "WeakAuras" }, { value = "index", label = "Baganator" }, { value = "toCollapse[index]", label = "Syndicator" } } }, { name = "expand", type = "bool", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_CurrencyInfo.GetCurrencyInfo"] = {
    ...
    params = { { name = "type", type = "number", default = nil , examples = { { value = 1, label = "WeakAuras" }, { value = "id", label = "Weekly" }, { value = 3292, label = "Narcissus" } } } },
...
APIDefs["C_CurrencyInfo.GetCurrencyLink"] = {
    ...
    params = { { name = "type", type = "number", default = nil , examples = { { value = "t.currencyID", label = "AllTheThings" }, { value = "details.currencyID", label = "Baganator" } } }, { name = "amount", type = "number", default = nil } },
...
APIDefs["C_CurrencyInfo.IsAccountTransferableCurrency"] = {
    ...
    params = { { name = "currencyID", type = "number", default = nil , examples = { { value = "id", label = "BagBrother" } } } },
...
APIDefs["C_CurrencyInfo.SetCurrencyBackpack"] = {
    ...
    params = { { name = "index", type = "luaIndex", default = nil , examples = { { value = "index", label = "Baganator" } } }, { name = "backpack", type = "bool", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
