...
APIDefs["C_Map.GetAreaInfo"] = {
    ...
    params = { { name = "areaID", type = "number", default = nil , examples = { { value = "id", label = "WeakAuras" }, { value = 4892, label = "AllTheThings" }, { value = 7932, label = "AllTheThings" } } } },
...
APIDefs["C_Map.GetBestMapForUnit"] = {
    ...
    params = { { name = "unitToken", type = "UnitToken", default = "player" , examples = { { value = "player", label = "WeakAuras" }, { value = "unit", label = "Narcissus" } } } },
...
APIDefs["C_Map.GetMapArtLayerTextures"] = {
    ...
    params = { { name = "uiMapID", type = "number", default = nil , examples = { { value = "background", label = "MRT" }, { value = "mapID", label = "Narcissus" } } }, { name = "layerIndex", type = "luaIndex", default = nil } },
...
APIDefs["C_Map.GetMapArtLayers"] = {
    ...
    params = { { name = "uiMapID", type = "number", default = nil , examples = { { value = "arg1", label = "Leatrix_Maps" } } } },
...
APIDefs["C_Map.GetMapChildrenInfo"] = {
    ...
    params = { { name = "uiMapID", type = "number", default = nil , examples = { { value = "id", label = "WeakAuras" } } }, { name = "mapType", type = "UIMapType", default = nil }, { name = "allDescendants", type = "bool", default = nil } },
...
APIDefs["C_Map.GetMapGroupID"] = {
    ...
    params = { { name = "uiMapID", type = "number", default = nil , examples = { { value = "id", label = "TomTom" } } } },
...
APIDefs["C_Map.GetMapGroupMembersInfo"] = {
    ...
    params = { { name = "uiMapGroupID", type = "number", default = nil , examples = { { value = "tonumber(id)", label = "WeakAuras" } } } },
    returns = { { name = "info", type = "table", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Map.GetMapInfo"] = {
    ...
    params = { { name = "uiMapID", type = "number", default = nil , examples = { { value = "tonumber(firstMapId:sub(2)) or 0", label = "DBM-Core" }, { value = "tonumber(name:sub(2)) or 0", label = "DBM-Core" }, { value = "arg1", label = "Leatrix_Maps" } } } },
...
APIDefs["C_Map.GetMapInfoAtPosition"] = {
    ...
    params = { { name = "uiMapID", type = "number", default = nil , examples = { { value = 109, label = "Narcissus_Barbershop" } } }, { name = "x", type = "number", default = nil }, { name = "y", type = "number", default = nil }, { name = "ignoreZoneMapPositionData", type = "bool", default = nil } },
    returns = { { name = "info", type = "UiMapDetails", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Map.GetMapRectOnMap"] = {
    ...
    params = { { name = "uiMapID", type = "number", default = nil , examples = { { value = "id", label = "TomTom" } } }, { name = "topUiMapID", type = "number", default = nil } },
...
APIDefs["C_Map.GetPlayerMapPosition"] = {
    ...
    params = { { name = "uiMapID", type = "number", default = nil , examples = { { value = "mapID", label = "Weekly" }, { value = "id", label = "AllTheThings" }, { value = "ATTC.RealMapID", label = "AllTheThings" } } }, { name = "unitToken", type = "UnitToken", default = "player" } },
...
APIDefs["C_Map.GetUserWaypointPositionForMap"] = {
    ...
    params = { { name = "uiMapID", type = "number", default = nil , examples = { { value = 12, label = "Narcissus" } } } },
...
APIDefs["C_Map.GetWorldPosFromMapPos"] = {
    ...
    params = { { name = "uiMapID", type = "number", default = nil , examples = { { value = [=[tonumber(customAreaID) or C_Map.GetBestMapForUnit("player") or 0]=], label = "DBM-Core" }, { value = [=[tonumber(AreaID) or C_Map.GetBestMapForUnit("player") or 0]=], label = "DBM-Core" }, { value = "mapID", label = "Leatrix_Plus" } } }, { name = "mapPosition", type = "vector2", default = nil } },
...
APIDefs["C_Map.SetUserWaypoint"] = {
    ...
    params = { { name = "point", type = "UiMapPoint", default = nil , examples = { { value = "UiMapPoint.CreateFromVector2D(1525", label = "Leatrix_Plus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
