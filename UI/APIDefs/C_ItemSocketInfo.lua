...
APIDefs["C_ItemSocketInfo.ClickSocketButton"] = {
    ...
    params = { { name = "index", type = "luaIndex", default = nil , examples = { { value = 1, label = "Narcissus" } } } },
    returns = {  },
...
APIDefs["C_ItemSocketInfo.IsArtifactRelicItem"] = {
    ...
    params = { { name = "info", type = "ItemInfo", default = nil , examples = { { value = "Info.Item.ID", label = "Pawn" } } } },
