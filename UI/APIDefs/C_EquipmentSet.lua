...
APIDefs["C_EquipmentSet.GetEquipmentSetInfo"] = {
    ...
    params = { { name = "equipmentSetID", type = "number", default = nil , examples = { { value = "id", label = "WeakAuras" }, { value = "location", label = "Baganator" }, { value = "location", label = "Baganator" } } } },
...
APIDefs["C_EquipmentSet.PickupEquipmentSet"] = {
    ...
    params = { { name = "equipmentSetID", type = "number", default = nil , examples = { { value = "target", label = "Bartender4" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
