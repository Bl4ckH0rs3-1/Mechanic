...
APIDefs["table.count"] = {
    ...
    params = { { name = "table", type = "LuaValueReference", default = nil , examples = { { value = "not typical 3", label = "DBM-Party-Legion" }, { value = "combatDataString", label = "Details" } } } },
...
APIDefs["table.create"] = {
    ...
    params = { { name = "arraySizeHint", type = "number", default = nil , examples = { { value = "region", label = "WeakAuras" }, { value = "region", label = "WeakAuras" }, { value = "region", label = "WeakAuras" } } }, { name = "nodeSizeHint", type = "number", default = 0 } },
