...
APIDefs["C_AccountStore.GetCategoryInfo"] = {
    ...
    params = { { name = "categoryID", type = "number", default = nil , examples = { { value = 15301, label = "AllTheThings" }, { value = 14941, label = "AllTheThings" }, { value = 15304, label = "AllTheThings" } } } },
...
APIDefs["C_AccountStore.GetCurrencyInfo"] = {
    ...
    params = { { name = "currencyID", type = "number", default = nil , examples = { { value = 1, label = "WeakAuras" }, { value = "id", label = "Weekly" }, { value = 3292, label = "Narcissus" } } } },
...
APIDefs["C_AccountStore.GetItemInfo"] = {
    ...
    params = { { name = "itemID", type = "number", default = nil , examples = { { value = "itemId or 0", label = "WeakAuras" }, { value = "itemname or 0", label = "WeakAuras" }, { value = "trigger.itemName or 0", label = "WeakAuras" } } } },
