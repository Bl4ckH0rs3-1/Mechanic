...
APIDefs["C_SpellBook.FindBaseSpellByID"] = {
    ...
    params = { { name = "spellID", type = "number", default = nil , examples = { { value = "spell", label = "WeakAuras" } } } },
...
APIDefs["C_SpellBook.GetSpellBookItemInfo"] = {
    ...
    params = { { name = "spellBookItemSlotIndex", type = "luaIndex", default = nil , examples = { { value = "math.random(1", label = "Dominos_Cast" }, { value = "i", label = "MRT" }, { value = "i", label = "Bartender4" } } }, { name = "spellBookItemSpellBank", type = "SpellBookSpellBank", default = nil } },
...
APIDefs["C_SpellBook.GetSpellBookItemName"] = {
    ...
    params = { { name = "spellBookItemSlotIndex", type = "luaIndex", default = nil , examples = { { value = "i", label = "Narcissus" } } }, { name = "spellBookItemSpellBank", type = "SpellBookSpellBank", default = nil } },
...
APIDefs["C_SpellBook.GetSpellBookItemTexture"] = {
    ...
    params = { { name = "spellBookItemSlotIndex", type = "luaIndex", default = nil , examples = { { value = "spellIndex", label = "Narcissus" }, { value = "i", label = "Narcissus" } } }, { name = "spellBookItemSpellBank", type = "SpellBookSpellBank", default = nil } },
...
APIDefs["C_SpellBook.GetSpellBookItemType"] = {
    ...
    params = { { name = "spellBookItemSlotIndex", type = "luaIndex", default = nil , examples = { { value = "index", label = "Bartender4" }, { value = "spellIndex", label = "Narcissus" } } }, { name = "spellBookItemSpellBank", type = "SpellBookSpellBank", default = nil } },
...
APIDefs["C_SpellBook.IsSpellBookItemInRange"] = {
    ...
    params = { { name = "spellBookItemSlotIndex", type = "luaIndex", default = nil , examples = { { value = "spellIdx", label = "Plater" } } }, { name = "spellBookItemSpellBank", type = "SpellBookSpellBank", default = nil }, { name = "targetUnit", type = "UnitToken", default = "player" } },
...
APIDefs["C_SpellBook.IsSpellInSpellBook"] = {
    ...
    params = { { name = "spellID", type = "number", default = nil , examples = { { value = "spellID", label = "Narcissus" } } }, { name = "spellBank", type = "SpellBookSpellBank", default = "Player" }, { name = "includeOverrides", type = "bool", default = true } },
...
APIDefs["C_SpellBook.IsSpellKnown"] = {
    ...
    params = { { name = "spellID", type = "number", default = nil , examples = { { value = "spell", label = "WeakAuras" }, { value = "baseSpell", label = "WeakAuras" }, { value = "spell", label = "WeakAuras" } } }, { name = "spellBank", type = "SpellBookSpellBank", default = "Player" } },
...
APIDefs["C_SpellBook.IsSpellKnownOrInSpellBook"] = {
    ...
    params = { { name = "spellID", type = "number", default = nil , examples = { { value = "spellID", label = "BigWigs_Core" }, { value = "spell", label = "BigWigs_Core" }, { value = "spell", label = "BigWigs_Core" } } }, { name = "spellBank", type = "SpellBookSpellBank", default = "Player" }, { name = "includeOverrides", type = "bool", default = true } },
