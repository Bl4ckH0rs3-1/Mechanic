...
APIDefs["C_MerchantFrame.GetItemInfo"] = {
    ...
    params = { { name = "index", type = "luaIndex", default = nil , examples = { { value = "itemId or 0", label = "WeakAuras" }, { value = "itemname or 0", label = "WeakAuras" }, { value = "trigger.itemName or 0", label = "WeakAuras" } } } },
