...
APIDefs["C_Calendar.GetHolidayInfo"] = {
    ...
    params = { { name = "monthOffset", type = "number", default = nil , examples = { { value = 0, label = "AllTheThings" } } }, { name = "monthDay", type = "luaIndex", default = nil }, { name = "index", type = "luaIndex", default = nil } },
...
APIDefs["C_Calendar.GetNumDayEvents"] = {
    ...
    params = { { name = "offsetMonths", type = "number", default = nil , examples = { { value = 0, label = "AllTheThings" } } }, { name = "monthDay", type = "luaIndex", default = nil } },
