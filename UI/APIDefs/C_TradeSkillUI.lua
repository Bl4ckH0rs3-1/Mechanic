...
APIDefs["C_TradeSkillUI.GetRecipeRequirements"] = {
    ...
    params = { { name = "recipeID", type = "number", default = nil , examples = { { value = 124052, label = "Plumber" } } } },
...
APIDefs["C_TradeSkillUI.GetRecipeSchematic"] = {
    ...
    params = { { name = "recipeSpellID", type = "number", default = nil , examples = { { value = 428667, label = "Plumber" } } }, { name = "isRecraft", type = "bool", default = nil }, { name = "recipeLevel", type = "luaIndex", default = nil } },
