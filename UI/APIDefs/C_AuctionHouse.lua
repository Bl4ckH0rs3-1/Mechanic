...
APIDefs["C_AuctionHouse.GetCommoditySearchResultInfo"] = {
    ...
    params = { { name = "itemID", type = "number", default = nil , examples = { { value = "itemID", label = "Auctionator" } } }, { name = "commoditySearchResultIndex", type = "luaIndex", default = nil } },
...
APIDefs["C_AuctionHouse.GetItemKeyInfo"] = {
    ...
    params = { { name = "itemKey", type = "ItemKey", default = nil , examples = { { value = "info.itemKey", label = "Auctionator" } } }, { name = "restrictQualityToFilter", type = "bool", default = false } },
...
APIDefs["C_AuctionHouse.GetItemSearchResultInfo"] = {
    ...
    params = { { name = "itemKey", type = "ItemKey", default = nil , examples = { { value = "itemKey", label = "AllTheThings" }, { value = "itemKey", label = "Auctionator" } } }, { name = "itemSearchResultIndex", type = "luaIndex", default = nil } },
...
APIDefs["C_AuctionHouse.QueryOwnedAuctions"] = {
    ...
    params = { { name = "sorts", type = "table", default = nil , examples = { { value = "{{sortOrder = 1", label = "Auctionator" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_AuctionHouse.SendBrowseQuery"] = {
    ...
    params = { { name = "query", type = "AuctionHouseBrowseQuery", default = nil , examples = { { value = [=[{searchString = ""]=], label = "Auctionator" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
