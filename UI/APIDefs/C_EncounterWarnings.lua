...
APIDefs["C_EncounterWarnings.PlaySound"] = {
    ...
    params = { { name = "severity", type = "EncounterEventSeverity", default = nil , examples = { { value = 856, label = "WeakAurasOptions" }, { value = 857, label = "WeakAurasOptions" }, { value = 852, label = "WeakAurasOptions" } } } },
