...
APIDefs["C_AzeriteEmpoweredItem.GetPowerText"] = {
    ...
    params = { { name = "azeriteEmpoweredItemLocation", type = "AzeriteEmpoweredItemLocation", default = nil , examples = { { value = "itemLocation", label = "Narcissus" } } }, { name = "powerID", type = "number", default = nil }, { name = "level", type = "AzeritePowerLevel", default = nil } },
...
APIDefs["C_AzeriteEmpoweredItem.IsPowerAvailableForSpec"] = {
    ...
    params = { { name = "powerID", type = "number", default = nil , examples = { { value = "TraitsCache[i][1]", label = "Narcissus" } } }, { name = "specID", type = "number", default = nil } },
