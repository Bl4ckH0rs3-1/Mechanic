...
APIDefs["C_ContentTracking.GetTitle"] = {
    ...
    params = { { name = "trackableType", type = "ContentTrackingType", default = nil , examples = { { value = "id", label = "Narcissus" }, { value = "matchedIDs[i][2]", label = "Narcissus" } } }, { name = "trackableID", type = "number", default = nil } },
...
APIDefs["C_ContentTracking.GetTrackedIDs"] = {
    ...
    params = { { name = "trackableType", type = "ContentTrackingType", default = nil , examples = { { value = 2, label = "BigWigs_Plugins" } } } },
...
APIDefs["C_ContentTracking.IsTracking"] = {
    ...
    params = { { name = "type", type = "ContentTrackingType", default = nil , examples = { { value = "TRACKING_TYPE_ACHV", label = "Narcissus_Achievements" }, { value = "type", label = "AllTheThings" } } }, { name = "id", type = "number", default = nil } },
...
APIDefs["C_ContentTracking.StartTracking"] = {
    ...
    params = { { name = "type", type = "ContentTrackingType", default = nil , examples = { { value = "TRACKING_TYPE_ACHV", label = "Narcissus_Achievements" }, { value = "trackType", label = "Plumber" }, { value = "type", label = "AllTheThings" } } }, { name = "id", type = "number", default = nil } },
...
APIDefs["C_ContentTracking.StopTracking"] = {
    ...
    params = { { name = "type", type = "ContentTrackingType", default = nil , examples = { { value = "TRACKING_TYPE_ACHV", label = "Narcissus_Achievements" }, { value = "trackType", label = "Plumber" }, { value = "type", label = "AllTheThings" } } }, { name = "id", type = "number", default = nil }, { name = "stopType", type = "ContentTrackingStopType", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_ContentTracking.ToggleTracking"] = {
    ...
    params = { { name = "type", type = "ContentTrackingType", default = nil , examples = { { value = "id", label = "Narcissus_Achievements" } } }, { name = "id", type = "number", default = nil }, { name = "stopType", type = "ContentTrackingStopType", default = nil } },
    returns = { { name = "error", type = "ContentTrackingError", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
