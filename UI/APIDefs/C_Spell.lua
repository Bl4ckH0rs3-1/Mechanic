...
APIDefs["C_Spell.GetOverrideSpell"] = {
    ...
    params = { { name = "spellIdentifier", type = "SpellIdentifier", default = nil , examples = { { value = 439052, label = "Narcissus" }, { value = 439053, label = "Narcissus" } } }, { name = "spec", type = "number", default = 0 }, { name = "onlyKnown", type = "bool", default = true }, { name = "ignoreOverrideSpellID", type = "number", default = 0 } },
...
APIDefs["C_Spell.GetSchoolString"] = {
    ...
    params = { { name = "schoolMask", type = "number", default = nil , examples = { { value = 1, label = "WeakAuras" }, { value = 2, label = "WeakAuras" }, { value = 4, label = "WeakAuras" } } } },
...
APIDefs["C_Spell.GetSpellCharges"] = {
    ...
    params = { { name = "spellIdentifier", type = "SpellIdentifier", default = nil , examples = { { value = "id", label = "WeakAuras" }, { value = 372608, label = "Flightsim" }, { value = "id", label = "WeakAuras" } } } },
...
APIDefs["C_Spell.GetSpellCooldown"] = {
    ...
    params = { { name = "spellIdentifier", type = "SpellIdentifier", default = nil , examples = { { value = 29515, label = "WeakAuras" }, { value = 5019, label = "WeakAuras" }, { value = 61304, label = "WeakAuras" } } } },
...
APIDefs["C_Spell.GetSpellDescription"] = {
    ...
    params = { { name = "spellIdentifier", type = "SpellIdentifier", default = nil , examples = { { value = "spell:GetSpellID()", label = "WeakAurasTemplates" }, { value = "item.spell", label = "WeakAurasTemplates" }, { value = "id", label = "BigWigs_Core" } } } },
...
APIDefs["C_Spell.GetSpellInfo"] = {
    ...
    params = { { name = "spellIdentifier", type = "SpellIdentifier", default = nil , examples = { { value = "id", label = "WeakAurasOptions" }, { value = 126, label = "Dominos" }, { value = [=[LeaPlusCB["Spell" .. i]:GetText()]=], label = "Leatrix_Plus" } } } },
...
APIDefs["C_Spell.GetSpellLink"] = {
    ...
    params = { { name = "spellIdentifier", type = "SpellIdentifier", default = nil , examples = { { value = "id", label = "AllTheThings" }, { value = 6603, label = "Details" }, { value = "actor.id", label = "Details" } } }, { name = "glyphID", type = "number", default = nil } },
...
APIDefs["C_Spell.GetSpellName"] = {
    ...
    params = { { name = "spellIdentifier", type = "SpellIdentifier", default = nil , examples = { { value = 21127, label = "AllTheThings" }, { value = 147343, label = "AllTheThings" }, { value = 61820, label = "AllTheThings" } } } },
...
APIDefs["C_Spell.GetSpellTexture"] = {
    ...
    params = { { name = "spellIdentifier", type = "SpellIdentifier", default = nil , examples = { { value = "id", label = "WeakAurasOptions" }, { value = 135936, label = "DandersFrames" }, { value = "spell", label = "Plumber" } } } },
...
APIDefs["C_Spell.IsPressHoldReleaseSpell"] = {
    ...
    params = { { name = "spellIdentifier", type = "SpellIdentifier", default = nil , examples = { { value = "id", label = "Bartender4" } } } },
...
APIDefs["C_Spell.IsSpellDataCached"] = {
    ...
    params = { { name = "spellIdentifier", type = "SpellIdentifier", default = nil , examples = { { value = "self.id", label = "Plumber" } } } },
...
APIDefs["C_Spell.IsSpellInRange"] = {
    ...
    params = { { name = "spellIdentifier", type = "SpellIdentifier", default = nil , examples = { { value = "spellID", label = "MoveAny" }, { value = "index", label = "Plater" }, { value = "spellId", label = "WeakAuras" } } }, { name = "targetUnit", type = "UnitToken", default = "player" } },
...
APIDefs["C_Spell.IsSpellUsable"] = {
    ...
    params = { { name = "spellIdentifier", type = "SpellIdentifier", default = nil , examples = { { value = 372608, label = "Flightsim" } } } },
...
APIDefs["C_Spell.PickupSpell"] = {
    ...
    params = { { name = "spellIdentifier", type = "SpellIdentifier", default = nil , examples = { { value = "target", label = "Bartender4" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Spell.RequestLoadSpellData"] = {
    ...
    params = { { name = "spellIdentifier", type = "SpellIdentifier", default = nil , examples = { { value = "spell1", label = "Narcissus" }, { value = "spell2", label = "Narcissus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
