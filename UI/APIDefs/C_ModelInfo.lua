...
APIDefs["C_ModelInfo.GetModelSceneActorInfoByID"] = {
    ...
    params = { { name = "modelActorID", type = "number", default = nil , examples = { { value = "id", label = "Narcissus" }, { value = 156, label = "Narcissus" } } } },
...
APIDefs["C_ModelInfo.GetModelSceneCameraInfoByID"] = {
    ...
    params = { { name = "modelSceneCameraID", type = "number", default = nil , examples = { { value = 114, label = "Narcissus" } } } },
