...
APIDefs["C_Transmog.GetSlotVisualInfo"] = {
    ...
    params = { { name = "transmogLocation", type = "TransmogLocation", default = nil , examples = { { value = "CreateFromMixins(TransmogLocationMixin):Set(3", label = "Narcissus" }, { value = "(CreateFromMixins(TransmogLocationMixin)):Set(3", label = "Narcissus" }, { value = 16, label = "Narcissus" } } } },
