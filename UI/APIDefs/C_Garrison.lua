...
APIDefs["C_Garrison.GetTalentInfo"] = {
    ...
    params = { { name = "talentID", type = "number", default = nil , examples = { { value = "{       tier = math.ceil(index / 3)", label = "WeakAuras" }, { value = "tier", label = "WeakAuras" }, { value = 2, label = "BigWigs_Core" } } } },
