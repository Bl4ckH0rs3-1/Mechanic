...
APIDefs["C_UIWidgetManager.GetIconAndTextWidgetVisualizationInfo"] = {
    ...
    params = { { name = "widgetID", type = "number", default = nil , examples = { { value = "id", label = "DBM-Party-BC" } } } },
...
APIDefs["C_UIWidgetManager.GetScenarioHeaderDelvesWidgetVisualizationInfo"] = {
    ...
    params = { { name = "widgetID", type = "number", default = nil , examples = { { value = 6183, label = "BigWigs_Plugins" }, { value = 6184, label = "BigWigs_Plugins" }, { value = 6185, label = "BigWigs_Plugins" } } } },
...
APIDefs["C_UIWidgetManager.GetScenarioHeaderTimerWidgetVisualizationInfo"] = {
    ...
    params = { { name = "widgetID", type = "number", default = nil , examples = { { value = 4997, label = "Plumber" } } } },
...
APIDefs["C_UIWidgetManager.GetSpellDisplayVisualizationInfo"] = {
    ...
    params = { { name = "widgetID", type = "number", default = nil , examples = { { value = 6023, label = "Plumber" } } } },
...
APIDefs["C_UIWidgetManager.GetStatusBarWidgetVisualizationInfo"] = {
    ...
    params = { { name = "widgetID", type = "number", default = nil , examples = { { value = 5136, label = "Plumber" }, { value = 4969, label = "Plumber" }, { value = "id", label = "BigWigs_Core" } } } },
...
APIDefs["C_UIWidgetManager.GetTextWithStateWidgetVisualizationInfo"] = {
    ...
    params = { { name = "widgetID", type = "number", default = nil , examples = { { value = 5328, label = "Plumber" }, { value = "id", label = "BigWigs_Core" } } } },
