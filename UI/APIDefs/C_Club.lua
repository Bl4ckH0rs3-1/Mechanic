...
APIDefs["C_Club.SendMessage"] = {
    ...
    params = { { name = "clubId", type = "ClubId", default = nil , examples = { { value = 'CACHE_BANK_OPENED', label = "Bagnon" }, { value = 'CACHE_BANK_CLOSED', label = "Bagnon" }, { value = 'CACHE_VAULT_OPENED', label = "Bagnon" } } }, { name = "streamId", type = "ClubStreamId", default = nil }, { name = "message", type = "string", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_Club.SetFavorite"] = {
    ...
    params = { { name = "clubId", type = "ClubId", default = nil , examples = { { value = "NarciAnimationInfo.IsFavorite(id)", label = "Narcissus" } } }, { name = "isFavorite", type = "bool", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
