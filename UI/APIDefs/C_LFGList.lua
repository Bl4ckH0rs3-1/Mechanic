...
APIDefs["C_LFGList.Search"] = {
    ...
    params = { { name = "categoryID", type = "number", default = nil , examples = { { value = "f", label = "AllTheThings" }, { value = "itemID", label = "AllTheThings" }, { value = "questID", label = "AllTheThings" } } }, { name = "filter", type = "number", default = 0 }, { name = "preferredFilters", type = "number", default = 0 }, { name = "languageFilter", type = "WowLocale", default = nil }, { name = "searchCrossFactionListings", type = "bool", default = false }, { name = "advancedFilter", type = "AdvancedFilterOptions", default = nil }, { name = "activityIDsFilter", type = "table", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
