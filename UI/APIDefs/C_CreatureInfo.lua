...
APIDefs["C_CreatureInfo.GetClassInfo"] = {
    ...
    params = { { name = "classID", type = "number", default = nil , examples = { { value = "playerInfo.class or 0", label = "Details" }, { value = "playerClassTable[playerTable[1]] or 0", label = "Details" }, { value = 1, label = "MRT" } } } },
