...
APIDefs["C_MapExplorationInfo.GetExploredAreaIDsAtPosition"] = {
    ...
    params = { { name = "uiMapID", type = "number", default = nil , examples = { { value = "ATTC.RealMapID", label = "AllTheThings" }, { value = 109, label = "Narcissus_Barbershop" } } }, { name = "normalizedPosition", type = "vector2", default = nil } },
...
APIDefs["C_MapExplorationInfo.GetExploredMapTextures"] = {
    ...
    params = { { name = "uiMapID", type = "number", default = nil , examples = { { value = 118, label = "Narcissus" } } } },
