...
APIDefs["C_EncounterJournal.GetSectionInfo"] = {
    ...
    params = { { name = "sectionID", type = "number", default = nil , examples = { { value = "ID", label = "Details" }, { value = "spell", label = "Details_EncounterDetails" } } } },
...
APIDefs["C_EncounterJournal.SetTab"] = {
    ...
    params = { { name = "tabIdx", type = "number", default = nil , examples = { { value = 1, label = "Baganator" }, { value = 2, label = "Baganator" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
