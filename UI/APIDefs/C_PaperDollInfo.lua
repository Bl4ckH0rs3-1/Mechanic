...
APIDefs["C_PaperDollInfo.GetArmorEffectiveness"] = {
    ...
    params = { { name = "armor", type = "number", default = nil , examples = { { value = "effectiveArmor", label = "Narcissus" }, { value = "shieldBlockArmor", label = "Narcissus" } } }, { name = "attackerLevel", type = "number", default = nil } },
