...
APIDefs["C_PartyInfo.DoCountdown"] = {
    ...
    params = { { name = "seconds", type = "number", default = nil , examples = { { value = 0, label = "MRT" }, { value = 10, label = "BigWigs_Plugins" } } } },
...
APIDefs["C_PartyInfo.InviteUnit"] = {
    ...
    params = { { name = "targetName", type = "cstring", default = nil , examples = { { value = "arg2", label = "Leatrix_Plus" }, { value = "unit", label = "Details" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_PartyInfo.RequestInviteFromUnit"] = {
    ...
    params = { { name = "targetName", type = "cstring", default = nil , examples = { { value = "addon.Unit(AstralMenuFrameUnit1.unit)", label = "AstralKeys" } } }, { name = "tank", type = "bool", default = nil }, { name = "healer", type = "bool", default = nil }, { name = "dps", type = "bool", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_PartyInfo.SetLootMethod"] = {
    ...
    params = { { name = "method", type = "LootMethod", default = nil , examples = { { value = "self.ref.id", label = "AllTheThings" }, { value = "self.ref.id", label = "AllTheThings" }, { value = "master", label = "AllTheThings" } } }, { name = "lootMaster", type = "string", default = nil } },
    returns = { { name = "success", type = "bool", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
