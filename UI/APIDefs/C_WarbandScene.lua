...
APIDefs["C_WarbandScene.IsFavorite"] = {
    ...
    params = { { name = "warbandSceneID", type = "number", default = nil , examples = { { value = "id", label = "!Mechanic" } } } },
...
APIDefs["C_WarbandScene.SetFavorite"] = {
    ...
    params = { { name = "warbandSceneID", type = "number", default = nil , examples = { { value = "NarciAnimationInfo.IsFavorite(id)", label = "Narcissus" } } }, { name = "favorite", type = "bool", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
