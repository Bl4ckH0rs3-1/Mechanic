...
APIDefs["C_Reputation.GetFactionDataByID"] = {
    ...
    params = { { name = "factionID", type = "number", default = nil , examples = { { value = "id", label = "Details" }, { value = 989, label = "Leatrix_Maps" } } } },
...
APIDefs["C_Reputation.SetReputationSortType"] = {
    ...
    params = { { name = "sortType", type = "ReputationSortType", default = nil , examples = { { value = 0, label = "WeakAuras" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
