...
APIDefs["C_WeeklyRewards.GetActivities"] = {
    ...
    params = { { name = "type", type = "WeeklyRewardChestThresholdType", default = nil , examples = { { value = 3, label = "Weekly" } } } },
...
APIDefs["C_WeeklyRewards.GetExampleRewardItemHyperlinks"] = {
    ...
    params = { { name = "id", type = "number", default = nil , examples = { { value = "id", label = "Plumber" }, { value = "activityInfo.id", label = "Plumber" }, { value = "self.info.id", label = "Plumber" } } } },
