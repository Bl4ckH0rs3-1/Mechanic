...
APIDefs["C_MajorFactions.GetCurrentRenownLevel"] = {
    ...
    params = { { name = "majorFactionID", type = "number", default = nil , examples = { { value = 2658, label = "Plumber" }, { value = 2722, label = "Plumber" } } } },
...
APIDefs["C_MajorFactions.GetMajorFactionIDs"] = {
    ...
    params = { { name = "expansionID", type = "number", default = nil , examples = { { value = 10, label = "AllTheThings" } } } },
...
APIDefs["C_MajorFactions.GetRenownRewardsForLevel"] = {
    ...
    params = { { name = "majorFactionID", type = "number", default = nil , examples = { { value = "factionID", label = "Plumber" } } }, { name = "renownLevel", type = "number", default = nil } },
