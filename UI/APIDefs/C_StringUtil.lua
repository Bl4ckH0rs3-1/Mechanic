...
APIDefs["C_StringUtil.WrapString"] = {
    ...
    params = { { name = "infix", type = "stringView", default = nil , examples = { { value = "truncated", label = "DandersFrames" }, { value = "text", label = "DBM-Core" }, { value = "text", label = "DBM-Core" } } }, { name = "prefix", type = "stringView", default = nil }, { name = "suffix", type = "stringView", default = nil } },
    returns = { { name = "text", type = "string", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenTainted",
...
APIDefs["C_StringUtil.trim"] = {
    ...
    params = { { name = "str", type = "stringView", default = nil , examples = { { value = "info[2]", label = "Narcissus" }, { value = "ID", label = "Plater" } } }, { name = "characters", type = "stringView", default = " \\r\\n\\t" } },
