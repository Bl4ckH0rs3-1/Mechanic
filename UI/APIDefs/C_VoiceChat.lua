...
APIDefs["C_VoiceChat.SetPortraitTexture"] = {
    ...
    params = { { name = "textureObject", type = "SimpleTexture", default = nil , examples = { { value = "self", label = "AllTheThings" }, { value = "self.Icon", label = "BagBrother" }, { value = 133139, label = "Narcissus" } } }, { name = "memberID", type = "number", default = nil }, { name = "channelID", type = "number", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
