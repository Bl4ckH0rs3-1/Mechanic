...
APIDefs["C_SpecializationInfo.GetInspectSelectedPvpTalent"] = {
    ...
    params = { { name = "inspectedUnit", type = "UnitToken", default = "player" , examples = { { value = "unit", label = "Narcissus" } } }, { name = "talentIndex", type = "number", default = nil } },
...
APIDefs["C_SpecializationInfo.GetPvpTalentSlotInfo"] = {
    ...
    params = { { name = "talentIndex", type = "number", default = nil , examples = { { value = 1, label = "WeakAuras" }, { value = "i - 3", label = "Narcissus" } } } },
...
APIDefs["C_SpecializationInfo.GetSpecializationInfo"] = {
    ...
    params = { { name = "specializationIndex", type = "luaIndex", default = nil , examples = { { value = "Private.ExecEnv.GetSpecialization() or 0", label = "WeakAuras" }, { value = "GetSpecialization() or 1", label = "DandersFrames" }, { value = "spec", label = "DejaCharacterStats" } } }, { name = "isInspect", type = "bool", default = false }, { name = "isPet", type = "bool", default = false }, { name = "inspectTarget", type = "string", default = nil }, { name = "sex", type = "number", default = nil }, { name = "groupIndex", type = "luaIndex", default = nil }, { name = "classID", type = "number", default = nil } },
...
APIDefs["C_SpecializationInfo.GetTalentInfo"] = {
    ...
    params = { { name = "query", type = "TalentInfoQuery", default = nil , examples = { { value = "{       tier = math.ceil(index / 3)", label = "WeakAuras" }, { value = "{tier=tier", label = "MRT" }, { value = "tier", label = "WeakAuras" } } } },
...
APIDefs["C_SpecializationInfo.SetSpecialization"] = {
    ...
    params = { { name = "specIndex", type = "luaIndex", default = nil , examples = { { value = 1, label = "Details" }, { value = 2, label = "Details" }, { value = 3, label = "Details" } } } },
