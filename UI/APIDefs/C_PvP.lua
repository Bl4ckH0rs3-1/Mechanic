...
APIDefs["C_PvP.GetScoreInfoByPlayerGuid"] = {
    ...
    params = { { name = "guid", type = "WOWGUID", default = nil , examples = { { value = [=[UnitGUID("player")]=], label = "Details" }, { value = "playerInfo.guid", label = "Details" } } } },
    returns = { { name = "info", type = "PVPScoreInfo", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
...
APIDefs["C_PvP.GetTeamInfo"] = {
    ...
    params = { { name = "factionIndex", type = "number", default = nil , examples = { { value = 0, label = "Details" }, { value = 1, label = "Details" } } } },
