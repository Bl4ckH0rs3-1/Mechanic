...
APIDefs["C_AchievementInfo.GetRewardItemID"] = {
    ...
    params = { { name = "achievementID", type = "number", default = nil , examples = { { value = "id", label = "Narcissus_Achievements" } } } },
...
APIDefs["C_AchievementInfo.SetPortraitTexture"] = {
    ...
    params = { { name = "textureObject", type = "SimpleTexture", default = nil , examples = { { value = "self", label = "AllTheThings" }, { value = "self.Icon", label = "BagBrother" }, { value = 133139, label = "Narcissus" } } } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
