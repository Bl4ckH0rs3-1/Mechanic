...
APIDefs["C_ChatInfo.IsAddonMessagePrefixRegistered"] = {
    ...
    params = { { name = "prefix", type = "cstring", default = nil , examples = { { value = "BigWigs", label = "DBM-Core" }, { value = "Transcriptor", label = "DBM-Core" } } } },
...
APIDefs["C_ChatInfo.RegisterAddonMessagePrefix"] = {
    ...
    params = { { name = "prefix", type = "cstring", default = nil , examples = { { value = "ATT", label = "AllTheThings" }, { value = "ATTC", label = "AllTheThings" }, { value = 'AstralKeys', label = "AstralKeys" } } } },
...
APIDefs["C_ChatInfo.SendAddonMessage"] = {
    ...
    params = { { name = "prefix", type = "cstring", default = nil , examples = { { value = "ATTC", label = "AllTheThings" }, { value = "ATTC", label = "AllTheThings" }, { value = "ATTC", label = "AllTheThings" } } }, { name = "message", type = "cstring", default = nil }, { name = "chatType", type = "cstring", default = nil }, { name = "target", type = "cstring", default = nil } },
...
APIDefs["C_ChatInfo.SendAddonMessageLogged"] = {
    ...
    params = { { name = "prefix", type = "cstring", default = nil , examples = { { value = "priority", label = "DBM-Core" }, { value = "priority", label = "DBM-Core" }, { value = "prio", label = "NoAutoClose" } } }, { name = "message", type = "cstring", default = nil }, { name = "chatType", type = "cstring", default = nil }, { name = "target", type = "cstring", default = nil } },
    returns = { { name = "result", type = "SendAddonMessageResult", canBeSecret = false } },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=NotAllowed",
...
APIDefs["C_ChatInfo.SendChatMessage"] = {
    ...
    params = { { name = "message", type = "cstring", default = nil , examples = { { value = [=[format("%%t " .. unitTag .. "(%d%%)%s"]=], label = "Leatrix_Plus" }, { value = [=[format("%%t " .. unitTag .. "(%d%%)%s"]=], label = "Leatrix_Plus" }, { value = "Quickly take orbs to these positions and click.", label = "Leatrix_Plus" } } }, { name = "chatType", type = "SendChatMessageType", default = nil }, { name = "languageID", type = "number", default = nil }, { name = "target", type = "cstring", default = nil } },
    returns = {  },
    midnightImpact = "RESTRICTED",
    protected = true,
    midnightNote = "Secret behavior: SecretArguments=AllowedWhenUntainted",
