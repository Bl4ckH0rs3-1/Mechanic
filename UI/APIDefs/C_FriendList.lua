...
APIDefs["C_FriendList.IsFriend"] = {
    ...
    params = { { name = "guid", type = "WOWGUID", default = nil , examples = { { value = "guid", label = "BigWigs_Plugins" } } } },
...
APIDefs["C_FriendList.SetFriendNotes"] = {
    ...
    params = { { name = "name", type = "cstring", default = nil , examples = { { value = "dfButton.playerName", label = "Details" } } }, { name = "notes", type = "cstring", default = nil } },
